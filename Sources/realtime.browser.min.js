! function(a, b) {
	"object" == typeof exports && "undefined" != typeof module ? b(exports) : "function" == typeof define && define.amd ? define("leancloud-realtime", ["exports"], b) : b(a.AV = a.AV || {})
}(this, function(a) {
	"use strict";
	...
	function d(a, b, c, d, e) {
		...
		return Object.keys(d).forEach(function(a) {
			f[a] = d[a]
		}), f.enumerable = !!f.enumerable, f.configurable = !!f.configurable, ("value" in f || f.initializer) && (f.writable = !0), f = c.slice().reverse().reduce(function(c, d) {
			return d(a, b, c) || c
		}, f), e && void 0 !== f.initializer && (f.value = f.initializer ? f.initializer.call(e) : void 0, f.initializer = void 0), void 0 === f.initializer && (Object.defineProperty(a, b, f), f = null), f
	}
	...
	function e() {
		var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
			...
			c = a.timestamp,
			d = a.nonce;
		if("string" != typeof b || "number" != typeof c || "string" != typeof d) throw new Error("malformed signature");
		return {
			signature: b,
			timestamp: c,
			nonce: d
	...
	var i = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
		...
		q = c(function(a) {
			var b = j,
				c = p.document,
				d = b(c) && b(c.createElement);
			a.exports = function(a) {
				return d ? c.createElement(a) : {}
			}
		}),
		r = c(function(a) {
		...
		s = c(function(a) {
			...
			a.exports = function(a, c) {
				if(!b(a)) return a;
				var d, e;
				if(c && "function" == typeof(d = a.toString) && !b(e = d.call(a))) return e;
				if("function" == typeof(d = a.valueOf) && !b(e = d.call(a))) return e;
				if(!c && "function" == typeof(d = a.toString) && !b(e = d.call(a))) return e;
		...
		t = c(function(a, b) {
			...
			b.f = o ? Object.defineProperty : function(a, b, g) {
				if(c(a), b = e(b, !0), c(g), d) try {
					return f(a, b, g)
				} catch(a) {}
		...
		u = c(function(a) {
			var b = k("meta"),
				...
				p = function(a) {
					return h && q.NEED && g(a) && !d(a, b) && i(a), a
				},
				q = a.exports = {
					KEY: b,
					NEED: !1,
		...
		z = c(function(a) {
			var b = t,
				c = y;
			a.exports = o ? function(a, d, e) {
				return b.f(a, d, c(1, e))
			} : function(a, b, c) {
				return a[b] = c, a
			}
		}),
			...
			var b = p,
				...
				g = function(a, h, i) {
					var j, k, l, m = a & g.F,
						...
						u = n ? b : o ? b[h] : (b[h] || {})[f];
					n && (i = h);
					for(j in i) k = !m && u && void 0 !== u[j], k && j in s || (l = k ? u[j] : i[j], s[j] = n && "function" != typeof u[j] ? i[j] : q && k ? d(l, b) : r && u[j] == l ? function(a) {
						...
						return b[f] = a[f], b
					}(l) : p && "function" == typeof l ? d(Function.call, l) : l, p && ((s.virtual || (s.virtual = {}))[j] = l, a & g.R && t && !t[j] && e(t, j, l)))
				};
			g.F = 1, g.G = 2, g.S = 4, g.P = 8, g.B = 16, g.W = 32, g.U = 64, g.R = 128, a.exports = g
		}),
		B = c(function(a) {
			var b = A,
				c = v,
			...
			a.exports = function(a, e) {
				var f = (c.Object || {})[a] || Object[a],
					g = {};
				g[a] = e(f), b(b.S + b.F * d(function() {
					f(1)
				}), "Object", g)
			}
		}),
		...
		N = c(function(a) {
			var b = M,
				c = Math.min;
			a.exports = function(a) {
				return a > 0 ? c(b(a), 9007199254740991) : 0
			}
		}),
		O = c(function(a) {
			var b = M,
				...
				d = Math.min;
			a.exports = function(a, e) {
				return a = b(a), a < 0 ? c(a + e, 0) : d(a, e)
			}
		}),
		P = c(function(a) {
			var b = L,
			...
			a.exports = function(a) {
				return function(e, f, g) {
					...
					if(a && f != f) {
						...
						for(; j > k; k++)
							if((a || k in i) && i[k] === f) return a || k || 0; return !a && -1
				}
			}
		}),
		Q = c(function(a) {
		...
		S = c(function(a) {
			...
			a.exports = function(a, f) {
				var g, h = c(a),
					i = 0,
					j = [];
				for(g in h) g != e && b(h, g) && j.push(g);
				for(; f.length > i;) b(h, g = f[i++]) && (~d(j, g) || j.push(g));
				return j
			}
		}),
		T = c(function(a) {
		...
		V = c(function(a) {
			...
			a.exports.f = function(a) {
				return e && "[object Window]" == d.call(a) ? f(a) : c(b(a))
			}
		}),
		W = (c(function(a) {
			B("getOwnPropertyNames", function() {
				return V.f
			})
		}), c(function(a) {
			var b = v.Object;
			a.exports = function(a) {
				return b.getOwnPropertyNames(a)
			}
		})),
		X = c(function(a) {
			a.exports = {
		...
		_ = c(function(a) {
			var b = Q("wks"),
				...
				d = p.Symbol,
				e = "function" == typeof d,
				f = a.exports = function(a) {
					return b[a] || (b[a] = e && d[a] || (e ? d : c)("Symbol." + a))
				};
			f.store = b
		}),
		aa = c(function(a) {
			...
			a.exports = function(a) {
				var e;
				return c(a) && (e = a.constructor, "function" != typeof e || e !== Array && !c(e.prototype) || (e = void 0), b(e) && (e = e[d], null === e && (e = void 0))), void 0 === e ? Array : e
			}
		}),
		ba = c(function(a) {
			var b = aa;
		...
		ca = c(function(a) {
			...
			a.exports = function(a, g) {
				var h = 1 == a,
					...
					m = 5 == a || l,
					n = g || f;
				return function(f, g, o) {
					for(var p, q, r = d(f), s = c(r), t = b(g, o, 3), u = e(s.length), v = 0, w = h ? n(f, u) : i ? n(f, 0) : void 0; u > v; v++)
		...
		da = c(function(a) {
			...
			a.exports = function(a, c) {
				return !!a && b(function() {
					c ? a.call(null, function() {}, 1) : a.call(null)
				})
			}
		}),
		ea = (c(function(a) {
			var b = A,
				c = ca(3);
			b(b.P + b.F * !da([].some, !0), "Array", {
				some: function(a) {
					return c(this, a, arguments[1])
				}
			})
		}), c(function(a) {
			a.exports = v.Array.some
		})),
		fa = c(function(a) {
			a.exports = {
				default: ea,
		...
		ja = c(function(a) {
			...
			a.exports = function(a) {
				return function(e) {
					for(var f, g = c(e), h = b(g), i = h.length, j = 0, k = []; i > j;) d.call(g, f = h[j++]) && k.push(a ? [f, g[f]] : g[f]);
					return k
				}
			}
		}),
		...
		ra = c(function(a) {
			var b = t,
				c = m,
				d = ha;
			a.exports = o ? Object.defineProperties : function(a, e) {
				c(a);
				for(var f, g = d(e), h = g.length, i = 0; h > i;) b.f(a, f = g[i++], e[f]);
				return a
			}
		}),
		sa = c(function(a) {
			a.exports = p.document && document.documentElement
		}),
		ta = c(function(a) {
			var b = m,
				c = ra,
				...
				h = function() {
					var a, b = q("iframe"),
						...
						e = "<",
						f = ">";
					for(b.style.display = "none", sa.appendChild(b), b.src = "javascript:", a = b.contentWindow.document, a.open(), a.write(e + "script" + f + "document.F=Object" + e + "/script" + f), a.close(), h = a.F; c--;) delete h[g][d[c]];
					return h()
				};
			a.exports = Object.create || function(a, d) {
				var i;
				return null !== a ? (f[g] = b(a), i = new f, f[g] = null, i[e] = a) : i = h(), void 0 === d ? i : c(i, d)
			}
		}),
		ua = c(function(a) {
			var b = t.f,
		...
		va = c(function(a) {
			var b = ta,
				...
				d = ua,
				e = {};
			z(e, _("iterator"), function() {
				return this
			}), a.exports = function(a, f, g) {
				a.prototype = b(e, {
					next: c(1, g)
				}), d(a, f + " Iterator")
			}
		...
		wa = c(function(a) {
			...
			a.exports = Object.getPrototypeOf || function(a) {
				return a = c(a), b(a, d) ? a[d] : "function" == typeof a.constructor && a instanceof a.constructor ? a.constructor.prototype : a instanceof Object ? e : null
			}
		}),
		xa = c(function(a) {
			var b = oa,
			...
			a.exports = function(a, l, r, s, t, u, v) {
				h(r, l, s);
				var w, x, y, z = function(a) {
						if(!m && a in D) return D[a];
						switch(a) {
							case o:
								return function() {
									return new r(this, a)
					...
					H = "Array" == l ? D.entries || E : E;
				if(H && (y = j(H.call(new a)), y !== Object.prototype && (i(y, A, !0), b || f(y, k) || e(y, k, q))), B && E && E.name !== p && (C = !0, F = function() {
						return E.call(this)
					}), b && !v || !m && !C && D[k] || e(D, k, F), g[l] = F, g[A] = q, t)
					if(w = {
							values: B ? F : z(p),
							keys: u ? F : z(o),
							entries: G
						}, v)
						for(x in w) x in D || d(D, x, w[x]);
					else c(c.P + c.F * (m || C), l, w);
				return w
			}
		}),
		ya = (c(function(a) {
			var b = na(!0);
			xa(String, "String", function(a) {
		...
		Aa = (c(function(a) {
			var b = ya,
				...
				d = qa,
				e = L;
			a.exports = xa(Array, "Array", function(a, b) {
				this._t = e(a), this._i = 0, this._k = b
			}, function() {
				var a = this._t,
					b = this._k,
					d = this._i++;
				return !a || d >= a.length ? (this._t = void 0, c(1)) : "keys" == b ? c(0, d) : "values" == b ? c(0, a[d]) : c(0, [d, a[d]])
			}, "values"), d.Arguments = d.Array, b("keys"), b("values"), b("entries")
		}), c(function(a) {
			for(var b = p, c = z, d = qa, e = _("toStringTag"), f = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], g = 0; g < 5; g++) {
				var h = f[g],
					i = b[h],
					j = i && i.prototype;
				j && !j[e] && c(j, e, h), d[h] = d.Array
			}
		}), c(function(a) {
			var b = I,
				c = _("toStringTag"),
				d = "Arguments" == b(function() {
					return arguments
				}()),
				e = function(a, b) {
					try {
			...
			a.exports = function(a) {
				var f, g, h;
				return void 0 === a ? "Undefined" : null === a ? "Null" : "string" == typeof(g = e(f = Object(a), c)) ? g : d ? b(f) : "Object" == (h = b(f)) && "function" == typeof f.callee ? "Arguments" : h
			}
		})),
		Ba = c(function(a) {
		...
		Ca = c(function(a) {
			...
			a.exports = function(a, c, d, e) {
				try {
					return e ? c(b(d)[0], d[1]) : c(d)
				} catch(c) {
					var f = a.return;
					throw void 0 !== f && b(f.call(a)), c
				}
			}
		}),
		Da = c(function(a) {
			var b = qa,
				...
				d = Array.prototype;
			a.exports = function(a) {
				return void 0 !== a && (b.Array === a || d[c] === a)
			}
		}),
		Ea = c(function(a) {
			var b = Aa,
				c = _("iterator"),
				d = qa;
			a.exports = v.getIteratorMethod = function(a) {
				if(void 0 != a) return a[c] || a["@@iterator"] || d[b(a)]
			}
		}),
		Fa = c(function(a) {
			var b = x,
				...
				h = {},
				i = {},
				j = a.exports = function(a, j, k, l, m) {
					...
					if(d(r)) {
						for(n = f(a.length); n > t; t++)
							if(q = j ? s(e(o = a[t])[0], o[1]) : s(a[t]), q === h || q === i) return q
					} else
						for(p = r.call(a); !(o = p.next()).done;)
							if(q = c(p, s, o.value, j), q === h || q === i) return q
				};
			j.BREAK = h, j.RETURN = i
		}),
		Ga = c(function(a) {
			var b = m,
				c = w,
				d = _("species");
			a.exports = function(a, e) {
				var f, g = b(a).constructor;
				return void 0 === g || void 0 == (f = b(g)[d]) ? e : c(f)
			}
		}),
		Ha = c(function(a) {
		...
		Ia = c(function(a) {
			...
			k && l || (k = function(a) {
				for(var c = [], d = 1; arguments.length > d;) c.push(arguments[d++]);
				return o[++n] = function() {
					f("function" == typeof a ? a : Function(a), c)
				}, b(n), n
			}, l = function(a) {
				delete o[a]
			}, "process" == I(j) ? b = function(a) {
				j.nextTick(e(s, a, 1))
			} : m ? (c = new m, d = c.port2, c.port1.onmessage = t, b = e(d.postMessage, d, 1)) : i.addEventListener && "function" == typeof postMessage && !i.importScripts ? (b = function(a) {
				i.postMessage(a + "", "*")
			}, i.addEventListener("message", t, !1)) : b = r in h("script") ? function(a) {
				g.appendChild(h("script"))[r] = function() {
					g.removeChild(this), s.call(a)
				}
			} : function(a) {
				setTimeout(e(s, a, 1), 0)
			}), a.exports = {
				set: k,
				clear: l
			}
		...
		Ja = c(function(a) {
			var b = p,
				...
				g = "process" == I(e);
			a.exports = function() {
				var a, h, i, j = function() {
					var b, c;
					for(g && (b = e.domain) && b.exit(); a;) {
						c = a.fn, a = a.next;
						try {
							c()
						} catch(b) {
							throw a ? i() : h = void 0, b
						}
					}
					h = void 0, b && b.enter()
				};
		...
		Ka = c(function(a) {
			var b = z;
			a.exports = function(a, c, d) {
				for(var e in c) d && a[e] ? a[e] = c[e] : b(a, e, c[e]);
				return a
			}
		}),
		La = c(function(a) {
			var b = p,
				...
				f = _("species");
			a.exports = function(a) {
				var g = "function" == typeof c[a] ? c[a] : b[a];
				e && g && !g[f] && d.f(g, f, {
					configurable: !0,
					get: function() {
						return this
		...
		Na = (c(function(a) {
			var b, c, d, e = oa,
				...
				C = !! function() {
					try {
						var a = y.resolve(1),
							b = (a.constructor = {})[_("species")] = function(a) {
								a(B, B)
							};
						return(z || "function" == typeof PromiseRejectionEvent) && a.then(B) instanceof b
					} catch(a) {}
				}(),
				D = function(a, b) {
					return a === b || a === y && b === d
						...
						r(function() {
							for(var d = a._v, e = 1 == a._s, f = 0, g = function(b) {
									var c, f, g = e ? b.ok : b.fail,
										...
										j = b.domain;
									try {
										g ? (e || (2 == a._h && L(a), a._h = 1), g === !0 ? c = d : (j && j.enter(), c = g(d), j && j.exit()), c === b.promise ? i(t("Promise-chain cycle")) : (f = E(c)) ? f.call(c, h, i) : h(c)) : i(d)
									} catch(a) {
										i(a)
									}
								}; c.length > f;) g(c[f++]);
							a._c = [], a._n = !1, b && !a._h && J(a)
						})
					}
				},
				J = function(a) {
					q.call(f, function() {
						var b, c, d, e = a._v;
						if(K(a) && (b = H(function() {
								z ? u.emit("unhandledRejection", e, a) : (c = f.onunhandledrejection) ? c({
									promise: a,
									reason: e
								}) : (d = f.console) && d.error && d.error("Unhandled promise rejection", e)
							}), a._h = z || K(a) ? 2 : 1), a._a = void 0, b) throw b.error
					})
				},
				K = function(a) {
					if(1 == a._h) return !1;
				...
				L = function(a) {
					q.call(f, function() {
						var b;
						z ? u.emit("rejectionHandled", a) : (b = f.onrejectionhandled) && b({
							promise: a,
							reason: a._v
						})
					})
			...
			C || (y = function(a) {
				m(this, y, s, "_h"), l(a), b.call(this);
				try {
					a(g(N, this, 1), g(M, this, 1))
				} catch(a) {
					M.call(this, a)
				}
			}, b = function(a) {
				this._c = [], this._a = void 0, this._s = 0, this._d = !1, this._v = void 0, this._h = 0, this._n = !1
			}, b.prototype = Ka(y.prototype, {
				then: function(a, b) {
					var c = F(o(this, y));
					return c.ok = "function" != typeof a || a, c.fail = "function" == typeof b && b, c.domain = z ? u.domain : void 0, this._c.push(c), this._a && this._a.push(c), this._s && I(this, !1), c.promise
				},
				catch: function(a) {
				...
				var a = new b;
				this.promise = a, this.resolve = g(N, a, 1), this.reject = g(M, a, 1)
			}), i(i.G + i.W + i.F * !C, {
				Promise: y
			}), ua(y, s), La(s), d = v[s], i(i.S + i.F * !C, s, {
				reject: function(a) {
					var b = F(this),
						c = b.reject;
				...
				resolve: function(a) {
					if(a instanceof y && D(a.constructor, this)) return a;
					var b = F(this),
						c = b.resolve;
					return c(a), b.promise
				}
			}), i(i.S + i.F * !(C && Ma(function(a) {
				y.all(a).catch(B)
			})), s, {
				all: function(a) {
					var b = this,
		...
		Ra = c(function(a) {
			...
			a.exports = !g || n(function() {
				...
				return a[c] = 7, d.split("").forEach(function(a) {
					b[a] = a
				}), 7 != g({}, a)[c] || Object.keys(g({}, b)).join("") != d
			}) ? function(a, g) {
				for(var h = e(a), i = arguments.length, j = 1, k = c.f, l = d.f; i > j;)
					for(var m, n = f(arguments[j++]), o = k ? b(n).concat(k(n)) : b(n), p = o.length, q = 0; p > q;) l.call(n, m = o[q++]) && (h[m] = n[m]);
				return h
			} : g
		}),
		Sa = (c(function(a) {
		...
		$a = c(function(a) {
			var b = p,
				...
				f = t.f;
			a.exports = function(a) {
				var g = c.Symbol || (c.Symbol = d ? {} : b.Symbol || {});
				"_" == a.charAt(0) || a in g || f(g, a, {
					value: e.f(a)
				})
			}
		}),
		_a = c(function(a) {
			var b = ha,
				c = L;
			a.exports = function(a, d) {
				for(var e, f = c(a), g = b(f), h = g.length, i = 0; h > i;)
					if(f[e = g[i++]] === d) return e
			}
		}),
		ab = c(function(a) {
			var b = ha,
			...
			a.exports = function(a) {
				var e = b(a),
					f = c.f;
				if(f)
					for(var g, h = f(a), i = d.f, j = 0; h.length > j;) i.call(a, g = h[j++]) && e.push(g);
				return e
			}
		}),
		bb = c(function(a, b) {
			...
			b.f = o ? i : function(a, b) {
				if(a = e(a), b = f(b, !0), h) try {
					return i(a, b)
				} catch(a) {}
				if(g(a, b)) return d(!c.f.call(a, b), a[b])
			}
		}),
		cb = (c(function(a) {
			var b = p,
				...
				aa = i("symbol-registry"),
				ba = i("symbols"),
				ca = i("op-symbols"),
				da = Object[W],
				ea = "function" == typeof R,
				fa = b.QObject,
				ga = !fa || !fa[W] || !fa[W].findChild,
				ja = d && h(function() {
					return 7 != H(O({}, "a", {
						get: function() {
							return O(this, "a", {
					...
					var d = N(da, b);
					d && delete da[b], O(a, b, c), d && a !== da && O(da, b, d)
				} : O,
				ka = function(a) {
					var b = ba[a] = H(R[W]);
					return b._k = a, b
				},
				la = ea && "symbol" == typeof R.iterator ? function(a) {
					return "symbol" == typeof a
				} : function(a) {
					return a instanceof R
				},
				ma = function(a, b, d) {
					return a === da && ma(ca, b, d), D(a), b = F(b, !0), D(d), c(ba, b) ? (d.enumerable ? (c(a, X) && a[X][b] && (a[X][b] = !1), d = H(d, {
						enumerable: G(0, !1)
					})) : (c(a, X) || O(a, X, G(1, {})), a[X][b] = !0), ja(a, b, d)) : O(a, b, d)
				},
				na = function(a, b) {
					D(a);
					for(var c, d = B(b = E(b)), e = 0, f = d.length; f > e;) ma(a, c = d[e++], b[c]);
					return a
				},
				qa = function(a, b) {
					return void 0 === b ? H(a) : na(H(a), b)
				},
				ra = function(a) {
					var b = Z.call(this, a = F(a, !0));
					return !(this === da && c(ba, a) && !c(ca, a)) && (!(b || !c(this, a) || !c(ba, a) || c(this, X) && this[X][a]) || b)
				},
				sa = function(a, b) {
					if(a = E(a), b = F(b, !0), a !== da || !c(ba, b) || c(ca, b)) {
						var d = N(a, b);
						return !d || !c(ba, b) || c(a, X) && a[X][b] || (d.enumerable = !0), d
					}
				},
				va = function(a) {
					for(var b, d = P(E(a)), e = [], f = 0; d.length > f;) c(ba, b = d[f++]) || b == X || b == g || e.push(b);
					return e
				},
				wa = function(a) {
					for(var b, d = a === da, e = P(d ? ca : E(a)), f = [], g = 0; e.length > g;) !c(ba, b = e[g++]) || d && !c(da, b) || f.push(ba[b]);
					return f
				};
			ea || (R = function() {
				...
				var a = q(arguments.length > 0 ? arguments[0] : void 0),
					b = function(d) {
						this === da && b.call(ca, d), c(this, X) && c(this[X], a) && (this[X][a] = !1), ja(this, a, G(1, d))
					};
				return d && ga && ja(da, a, {
					configurable: !0,
					set: b
				}), ka(a)
			}, f(R[W], "toString", function() {
				return this._k
			}), J.f = sa, K.f = ma, U.f = I.f = va, ia.f = ra, Qa.f = wa, d && !oa && f(da, "propertyIsEnumerable", ra, !0), v.f = function(a) {
				return ka(r(a))
			}), e(e.G + e.W + e.F * !ea, {
				Symbol: R
			});
			for(var xa = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), ya = 0; xa.length > ya;) r(xa[ya++]);
			for(var xa = M(r.store), ya = 0; xa.length > ya;) w(xa[ya++]);
			e(e.S + e.F * !ea, "Symbol", {
				for: function(a) {
					return c(aa, a += "") ? aa[a] : aa[a] = R(a)
				},
				keyFor: function(a) {
					if(la(a)) return x(aa, a);
				...
				getOwnPropertySymbols: wa
			}), S && e(e.S + e.F * (!ea || h(function() {
				var a = R();
				return "[null]" != T([a]) || "{}" != T({
					a: a
				}) || "{}" != T(Object(a))
				...
				stringify: function(a) {
					if(void 0 !== a && !la(a)) {
						...
						return b = d[1], "function" == typeof b && (c = b), !c && C(b) || (b = function(a, b) {
							if(c && (b = c.call(this, a, b)), !la(b)) return b
						}), d[1] = b, T.apply(S, d)
					}
				}
			}), R[W][Y] || z(R[W], Y, R[W].valueOf), j(R, "Symbol"), j(Math, "Math", !0), j(b.JSON, "JSON", !0)
		}), c(function(a) {
			$a("asyncIterator")
		}), c(function(a) {
			$a("observable")
		...
		fb = c(function(a, b) {
			...
			var d = Za,
				...
				f = db,
				g = c(f),
				h = "function" == typeof g.default && "symbol" == typeof e.default ? function(a) {
					return typeof a
				} : function(a) {
					return a && "function" == typeof g.default && a.constructor === g.default && a !== g.default.prototype ? "symbol" : typeof a
				};
			b.default = "function" == typeof g.default && "symbol" === h(e.default) ? function(a) {
				return "undefined" == typeof a ? "undefined" : h(a)
			} : function(a) {
				return a && "function" == typeof g.default && a.constructor === g.default && a !== g.default.prototype ? "symbol" : "undefined" == typeof a ? "undefined" : h(a)
			}
		}),
		gb = b(fb),
		hb = c(function(a, b) {
			...
			b.default = function(a, b) {
				...
				return !b || "object" !== ("undefined" == typeof b ? "undefined" : (0, e.default)(b)) && "function" != typeof b ? a : b
			}
		}),
		ib = b(hb),
		jb = c(function(a) {
			var b = j,
				c = m,
				d = function(a, d) {
					if(c(a), !b(d) && null !== d) throw TypeError(d + ": can't set as prototype!")
				};
			a.exports = {
				set: Object.setPrototypeOf || ("__proto__" in {} ? function(a, b, c) {
					try {
						c = x(Function.call, bb.f(Object.prototype, "__proto__").set, 2), c(a, []), b = !(a instanceof Array)
					} catch(a) {
						b = !0
					}
					return function(a, e) {
		...
		kb = (c(function(a) {
			var b = A;
			b(b.S, "Object", {
				setPrototypeOf: jb.set
			})
		}), c(function(a) {
			a.exports = v.Object.setPrototypeOf
		})),
		lb = c(function(a) {
			a.exports = {
				default: kb,
		...
		ob = c(function(a, b) {
			...
			var d = lb,
				...
				i = c(h);
			b.default = function(a, b) {
				if("function" != typeof b && null !== b) throw new TypeError("Super expression must either be null or a function, not " + ("undefined" == typeof b ? "undefined" : (0, i.default)(b)));
		...
		qb = c(function(a) {
			...
			function c(a) {
				return a >= i ? Math.round(a / i) + "d" : a >= h ? Math.round(a / h) + "h" : a >= g ? Math.round(a / g) + "m" : a >= f ? Math.round(a / f) + "s" : a + "ms"
			}

			function d(a) {
				return e(a, i, "day") || e(a, h, "hour") || e(a, g, "minute") || e(a, f, "second") || a + " ms"
			}
			...
			a.exports = function(a, e) {
				e = e || {};
				var f = typeof a;
				if("string" === f && a.length > 0) return b(a);
				if("number" === f && isNaN(a) === !1) return e.long ? d(a) : c(a);
		...
		rb = c(function(a, b) {
				...
				function d() {
					if(d.enabled) {
						var a = d,
							c = +new Date,
							e = c - (i || c);
						a.diff = e, a.prev = i, a.curr = c, i = c;
						for(var f = new Array(arguments.length), h = 0; h < f.length; h++) f[h] = arguments[h];
						...
						f[0] = f[0].replace(/%([a-zA-Z%])/g, function(c, d) {
							...
							if("function" == typeof e) {
								var g = f[j];
								c = e.call(a, g), f.splice(j, 1), j--
							}
							return c
						}), b.formatArgs.call(a, f);
						var k = g.log || b.log || console.log.bind(console);
						k.apply(a, f)
					}
				}
				return d.namespace = a, d.enabled = b.enabled(a), d.useColors = b.useColors(), d.color = c(a), "function" == typeof b.init && b.init(d), d
			}
			...
			b = a.exports = d.debug = d.default = d, b.coerce = h, b.disable = f, b.enable = e, b.enabled = g, b.humanize = qb, b.names = [], b.skips = [], b.formatters = {};
			var i
		}),
		sb = c(function(a, b) {
			function c() {
				return "undefined" != typeof document && "WebkitAppearance" in document.documentElement.style || "undefined" != typeof window && window.console && (console.firebug || console.exception && console.table) || navigator.userAgent.toLowerCase().match(/firefox\/(\d+)/) && parseInt(RegExp.$1, 10) >= 31 || navigator.userAgent.toLowerCase().match(/applewebkit\/(\d+)/)
			}
			...
			function g() {
				...
				if("undefined" != typeof h && "env" in h) return h.env.DEBUG
			}
			...
			b = a.exports = rb, b.log = e, b.formatArgs = d, b.save = f, b.load = g, b.useColors = c, b.storage = "undefined" != typeof chrome && "undefined" != typeof chrome.storage ? chrome.storage.local : i(), b.colors = ["lightseagreen", "forestgreen", "goldenrod", "dodgerblue", "darkorchid", "crimson"], b.formatters.j = function(a) {
				try {
		...
		tb = c(function(a) {
			...
			var e = Object.prototype.hasOwnProperty,
				f = "~";
			Object.create && (b.prototype = Object.create(null), (new b).__proto__ || (f = !1)), d.prototype.eventNames = function() {
				var a, b, c = [];
				if(0 === this._eventsCount) return c;
				for(b in a = this._events) e.call(a, b) && c.push(f ? b.slice(1) : b);
				return Object.getOwnPropertySymbols ? c.concat(Object.getOwnPropertySymbols(a)) : c
			}, d.prototype.listeners = function(a, b) {
				var c = f ? f + a : a,
					d = this._events[c];
				if(b) return !!d;
				if(!d) return [];
				...
				return h
			}, d.prototype.emit = function(a, b, c, d, e, g) {
				var h = f ? f + a : a;
				...
				var e = new c(b, d || this),
					g = f ? f + a : a;
				return this._events[g] ? this._events[g].fn ? this._events[g] = [this._events[g], e] : this._events[g].push(e) : (this._events[g] = e, this._eventsCount++), this
			}, d.prototype.once = function(a, b, d) {
				var e = new c(b, d || this, !0),
					g = f ? f + a : a;
				return this._events[g] ? this._events[g].fn ? this._events[g] = [this._events[g], e] : this._events[g].push(e) : (this._events[g] = e, this._eventsCount++), this
			}, d.prototype.removeListener = function(a, c, d, e) {
				var g = f ? f + a : a;
				if(!this._events[g]) return this;
				if(!c) return 0 === --this._eventsCount ? this._events = new b : delete this._events[g], this;
				var h = this._events[g];
				if(h.fn) h.fn !== c || e && !h.once || d && h.context !== d || (0 === --this._eventsCount ? this._events = new b : delete this._events[g]);
				else {
					for(var i = 0, j = [], k = h.length; i < k; i++)(h[i].fn !== c || e && !h[i].once || d && h[i].context !== d) && j.push(h[i]);
					j.length ? this._events[g] = 1 === j.length ? j[0] : j : 0 === --this._eventsCount ? this._events = new b : delete this._events[g]
				}
				return this
			}, d.prototype.removeAllListeners = function(a) {
				var c;
				return a ? (c = f ? f + a : a, this._events[c] && (0 === --this._eventsCount ? this._events = new b : delete this._events[c])) : (this._events = new b, this._eventsCount = 0), this
			}, d.prototype.off = d.prototype.removeListener, d.prototype.addListener = d.prototype.on, d.prototype.setMaxListeners = function() {
				return this
			}, d.prefixed = f, d.EventEmitter = d, "undefined" != typeof a && (a.exports = d)
		}),
		ub = c(function(a) {
			a.exports = function(a, b) {
				return function() {
		...
		vb = c(function(a) {
			...
			function c(a) {
				return "[object ArrayBuffer]" === v.call(a)
			}
			...
			function e(a) {
				var b;
				return b = "undefined" != typeof ArrayBuffer && ArrayBuffer.isView ? ArrayBuffer.isView(a) : a && a.buffer && a.buffer instanceof ArrayBuffer
			}
			...
			function i(a) {
				return null !== a && "object" === ("undefined" == typeof a ? "undefined" : gb(a))
			}

			function j(a) {
				return "[object Date]" === v.call(a)
			}

			function k(a) {
				return "[object File]" === v.call(a)
			}

			function l(a) {
				return "[object Blob]" === v.call(a)
			}
			...
			function r(a, c) {
				if(null !== a && "undefined" != typeof a)
					if("object" === ("undefined" == typeof a ? "undefined" : gb(a)) || b(a) || (a = [a]), b(a))
						for(var d = 0, e = a.length; d < e; d++) c.call(null, a[d], d, a);
					else
						for(var f in a) Object.prototype.hasOwnProperty.call(a, f) && c.call(null, a[f], f, a)
			}

			function s() {
				function a(a, c) {
					"object" === gb(b[c]) && "object" === ("undefined" == typeof a ? "undefined" : gb(a)) ? b[c] = s(b[c], a) : b[c] = a
				}
				for(var b = {}, c = 0, d = arguments.length; c < d; c++) r(arguments[c], a);
				return b
			}

			function t(a, b, c) {
				return r(b, function(b, d) {
					c && "function" == typeof b ? a[d] = u(b, c) : a[d] = b
				}), a
			}
			var u = ub,
		...
		zb = c(function(a) {
			...
			a.exports = function(a, c) {
				b.forEach(a, function(b, d) {
					d !== c && d.toUpperCase() === c.toUpperCase() && (a[c] = b, delete a[d])
				})
			}
		}),
		Ab = c(function(a) {
			a.exports = function(a, b, c, d) {
				return a.config = b, c && (a.code = c), a.response = d, a
			}
		}),
		Bb = c(function(a) {
			var b = Ab;
		...
		Cb = c(function(a) {
			...
			a.exports = function(a, c, d) {
				...
				d.status && e && !e(d.status) ? c(b("Request failed with status code " + d.status, d.config, null, d)) : a(d)
			}
		}),
		Db = c(function(a) {
			function b(a) {
			...
			a.exports = function(a, d, e) {
				...
				var f;
				if(e) f = e(d);
				else if(c.isURLSearchParams(d)) f = d.toString();
				else {
					var g = [];
					c.forEach(d, function(a, d) {
						null !== a && "undefined" != typeof a && (c.isArray(a) && (d += "[]"), c.isArray(a) || (a = [a]), c.forEach(a, function(a) {
							c.isDate(a) ? a = a.toISOString() : c.isObject(a) && (a = yb(a)), g.push(b(d) + "=" + b(a))
						}))
					}), f = g.join("&")
				}
				return f && (a += (a.indexOf("?") === -1 ? "?" : "&") + f), a
			}
		}),
		Eb = c(function(a) {
			var b = vb;
			a.exports = function(a) {
				...
				return a ? (b.forEach(a.split("\n"), function(a) {
					e = a.indexOf(":"), c = b.trim(a.substr(0, e)).toLowerCase(), d = b.trim(a.substr(e + 1)), c && (f[c] = f[c] ? f[c] + ", " + d : d)
				}), f) : f
			}
		}),
		Fb = c(function(a) {
			...
			a.exports = b.isStandardBrowserEnv() ? function() {
				function a(a) {
					var b = a;
					return d && (e.setAttribute("href", b), b = e.href), e.setAttribute("href", b), {
						href: e.href,
				...
				var c, d = /(msie|trident)/i.test(navigator.userAgent),
					e = document.createElement("a");
				return c = a(window.location.href),
					function(d) {
						var e = b.isString(d) ? a(d) : d;
		...
		Gb = c(function(a) {
			...
			function c(a) {
				for(var c, e, f = String(a), g = "", h = 0, i = d; f.charAt(0 | h) || (i = "=", h % 1); g += i.charAt(63 & c >> 8 - h % 1 * 8)) {
					if(e = f.charCodeAt(h += .75), e > 255) throw new b;
					c = c << 8 | e
				}
				return g
			}
			var d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
			b.prototype = new Error, b.prototype.code = 5, b.prototype.name = "InvalidCharacterError", a.exports = c
		}),
		Hb = c(function(a) {
			var b = vb;
			a.exports = b.isStandardBrowserEnv() ? function() {
				return {
					write: function(a, c, d, e, f, g) {
						var h = [];
						h.push(a + "=" + encodeURIComponent(c)), b.isNumber(d) && h.push("expires=" + new Date(d).toGMTString()), b.isString(e) && h.push("path=" + e), b.isString(f) && h.push("domain=" + f), g === !0 && h.push("secure"), document.cookie = h.join("; ")
					},
					read: function(a) {
		...
		Ib = c(function(a) {
			var b = vb,
				...
				f = Fb,
				g = Bb,
				i = "undefined" != typeof window && window.btoa && window.btoa.bind(window) || Gb;
			a.exports = function(a) {
				return new Pa(function(j, k) {
					var l = a.data,
						m = a.headers;
					b.isFormData(l) && delete m["Content-Type"];
					var n = new XMLHttpRequest,
						o = "onreadystatechange",
						p = !1;
					if("test" === h.env.NODE_ENV || "undefined" == typeof window || !window.XDomainRequest || "withCredentials" in n || f(a.url) || (n = new window.XDomainRequest, o = "onload", p = !0, n.onprogress = function() {}, n.ontimeout = function() {}), a.auth) {
						var q = a.auth.username || "",
							r = a.auth.password || "";
						m.Authorization = "Basic " + i(q + ":" + r)
					}
					if(n.open(a.method.toUpperCase(), d(a.url, a.params, a.paramsSerializer), !0), n.timeout = a.timeout, n[o] = function() {
							if(n && (4 === n.readyState || p) && (0 !== n.status || n.responseURL && 0 === n.responseURL.indexOf("file:"))) {
								var b = "getAllResponseHeaders" in n ? e(n.getAllResponseHeaders()) : null,
									d = a.responseType && "text" !== a.responseType ? n.response : n.responseText,
									f = {
										data: d,
							...
							k(g("Network Error", a)), n = null
						}, n.ontimeout = function() {
							k(g("timeout of " + a.timeout + "ms exceeded", a, "ECONNABORTED")), n = null
						}, b.isStandardBrowserEnv()) {
						var s = Hb,
							t = (a.withCredentials || f(a.url)) && a.xsrfCookieName ? s.read(a.xsrfCookieName) : void 0;
						t && (m[a.xsrfHeaderName] = t)
					}
					if("setRequestHeader" in n && b.forEach(m, function(a, b) {
							"undefined" == typeof l && "content-type" === b.toLowerCase() ? delete m[b] : n.setRequestHeader(b, a)
						}), a.withCredentials && (n.withCredentials = !0), a.responseType) try {
						n.responseType = a.responseType
					} catch(a) {
						if("json" !== n.responseType) throw a
					}
					"function" == typeof a.onDownloadProgress && n.addEventListener("progress", a.onDownloadProgress), "function" == typeof a.onUploadProgress && n.upload && n.upload.addEventListener("progress", a.onUploadProgress), a.cancelToken && a.cancelToken.promise.then(function(a) {
						n && (n.abort(), k(a), n = null)
					}), void 0 === l && (l = null), n.send(l)
				})
			}
		}),
		Jb = c(function(a) {
			...
			function c() {
				var a;
				return "undefined" != typeof XMLHttpRequest ? a = Ib : "undefined" != typeof h && (a = Ib), a
			}
			var d = vb,
				e = zb,
				f = /^\)\]\}',?\n/,
				...
				i = {
					...
					transformRequest: [function(a, c) {
						return e(c, "Content-Type"), d.isFormData(a) || d.isArrayBuffer(a) || d.isStream(a) || d.isFile(a) || d.isBlob(a) ? a : d.isArrayBufferView(a) ? a.buffer : d.isURLSearchParams(a) ? (b(c, "application/x-www-form-urlencoded;charset=utf-8"), a.toString()) : d.isObject(a) ? (b(c, "application/json;charset=utf-8"), yb(a)) : a
					}],
		...
		Kb = c(function(a) {
			...
			var c = vb;
			b.prototype.use = function(a, b) {
				return this.handlers.push({
					fulfilled: a,
					rejected: b
				}), this.handlers.length - 1
			}, b.prototype.eject = function(a) {
		...
		Nb = c(function(a) {
			...
			var c = vb,
				...
				f = Jb;
			a.exports = function(a) {
				b(a), a.headers = a.headers || {}, a.data = d(a.data, a.headers, a.transformRequest), a.headers = c.merge(a.headers.common || {}, a.headers[a.method] || {}, a.headers || {}), c.forEach(["delete", "get", "head", "post", "put", "patch", "common"], function(b) {
					delete a.headers[b]
				});
				var g = a.adapter || f.adapter;
				return g(a).then(function(c) {
					return b(a), c.data = d(c.data, c.headers, a.transformResponse), c
				}, function(c) {
					return e(c) || (b(a), c && c.response && (c.response.data = d(c.response.data, c.response.headers, a.transformResponse))), Pa.reject(c)
				})
			}
		}),
		Ob = c(function(a) {
		...
		Qb = c(function(a) {
			...
			b.prototype.request = function(a) {
				"string" == typeof a && (a = d.merge({
					url: arguments[0]
				}, arguments[1])), a = d.merge(c, this.defaults, {
					method: "get"
				}, a), a.baseURL && !g(a.url) && (a.url = h(a.baseURL, a.url));
				var b = [f, void 0],
					e = Pa.resolve(a);
				for(this.interceptors.request.forEach(function(a) {
					...
					}); b.length;) e = e.then(b.shift(), b.shift());
				return e
			}, d.forEach(["delete", "get", "head"], function(a) {
				b.prototype[a] = function(b, c) {
					return this.request(d.merge(c || {}, {
						method: a,
						url: b
					}))
				}
			}), d.forEach(["post", "put", "patch"], function(a) {
				b.prototype[a] = function(b, c, e) {
					return this.request(d.merge(e || {}, {
						method: a,
						url: b,
						data: c
					}))
		...
		Sb = c(function(a) {
			function b(a) {
				...
				var b;
				this.promise = new Pa(function(a) {
					b = a
				});
				var d = this;
				a(function(a) {
					d.reason || (d.reason = new c(a), b(d.reason))
				})
			}
			var c = Rb;
		...
		Ub = c(function(a) {
			function b(a) {
				var b = new e(a),
					f = d(e.prototype.request, b);
				return c.extend(f, e.prototype, b), c.extend(f, b), f
			}
			var c = vb,
				d = ub,
				e = Qb,
				f = Jb,
				g = b(f);
			g.Axios = e, g.create = function(a) {
				return b(c.merge(f, a))
			}, g.Cancel = Rb, g.CancelToken = Sb, g.isCancel = Mb, g.all = function(a) {
				return Pa.all(a)
			}, g.spread = Tb, a.exports = g, a.exports.default = g
		}),
		Vb = c(function(a) {
			a.exports = Ub
		}),
		Wb = c(function(a) {
			var b, c = i.crypto || i.msCrypto;
			if(c && c.getRandomValues) {
				var d = new Uint8Array(16);
				b = function() {
					return c.getRandomValues(d), d
				}
			}
			if(!b) {
				var e = new Array(16);
				b = function() {
					for(var a, b = 0; b < 16; b++) 0 === (3 & b) && (a = 4294967296 * Math.random()), e[b] = a >>> ((3 & b) << 3) & 255;
					return e
				}
			}
			a.exports = b
		...
		Yb = c(function(a) {
			function b(a, b, c) {
				var e = b && c || 0,
					j = b || [];
				a = a || {};
				var k = void 0 !== a.clockseq ? a.clockseq : g,
					l = void 0 !== a.msecs ? a.msecs : (new Date).getTime(),
					m = void 0 !== a.nsecs ? a.nsecs : i + 1,
					n = l - h + (m - i) / 1e4;
				if(n < 0 && void 0 === a.clockseq && (k = k + 1 & 16383), (n < 0 || l > h) && void 0 === a.nsecs && (m = 0), m >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
				h = l, i = m, g = k, l += 122192928e5;
				var o = (1e4 * (268435455 & l) + m) % 4294967296;
				j[e++] = o >>> 24 & 255, j[e++] = o >>> 16 & 255, j[e++] = o >>> 8 & 255, j[e++] = 255 & o;
				var p = l / 4294967296 * 1e4 & 268435455;
				j[e++] = p >>> 8 & 255, j[e++] = 255 & p, j[e++] = p >>> 24 & 15 | 16, j[e++] = p >>> 16 & 255, j[e++] = k >>> 8 | 128, j[e++] = 255 & k;
				for(var q = a.node || f, r = 0; r < 6; ++r) j[e + r] = q[r];
				return b ? b : d(j)
			}
			var c = Wb,
				d = Xb,
				e = c(),
				f = [1 | e[0], e[1], e[2], e[3], e[4], e[5]],
				g = 16383 & (e[6] << 8 | e[7]),
				h = 0,
				i = 0;
			a.exports = b
		...
		Zb = c(function(a) {
			function b(a, b, e) {
				...
				var g = a.random || (a.rng || c)();
				if(g[6] = 15 & g[6] | 64, g[8] = 63 & g[8] | 128, b)
					for(var h = 0; h < 16; ++h) b[f + h] = g[h];
				return b || d(g)
			}
			var c = Wb,
				d = Xb;
		...
		$b = c(function(a) {
			var b = Yb,
				c = Zb,
				d = c;
			d.v1 = b, d.v4 = c, a.exports = d
		}),
		_b = (c(function(a) {
			var b = L,
				c = bb.f;
			B("getOwnPropertyDescriptor", function() {
				return function(a, d) {
					return c(b(a), d)
				}
			})
			...
			var b = v.Object;
			a.exports = function(a, c) {
				return b.getOwnPropertyDescriptor(a, c)
			}
		})),
		ac = c(function(a) {
			a.exports = {
		...
		cc = c(function(a, b) {
			! function() {
				var c = {
					...
					ASYNC: "async",
					create: function(a, b) {
						var d = "string" == typeof a.initial ? {
								state: a.initial
							} : a.initial,
							e = a.terminal || a.final,
							f = b || a.target || {},
							g = a.events || [],
							h = a.callbacks || {},
							i = {},
							j = {},
							k = function(a) {
								var b = Array.isArray(a.from) ? a.from : a.from ? [a.from] : [c.WILDCARD];
								i[a.name] = i[a.name] || {};
								for(var d = 0; d < b.length; d++) j[b[d]] = j[b[d]] || [], j[b[d]].push(a.name), i[a.name][b[d]] = a.to || b[d];
								a.to && (j[a.to] = j[a.to] || [])
							};
						...
						for(var m in i) i.hasOwnProperty(m) && (f[m] = c.buildEvent(m, i[m]));
						for(var m in h) h.hasOwnProperty(m) && (f[m] = h[m]);
						return f.current = "none", f.is = function(a) {
							return Array.isArray(a) ? a.indexOf(this.current) >= 0 : this.current === a
						}, f.can = function(a) {
							return !this.transition && void 0 !== i[a] && (i[a].hasOwnProperty(this.current) || i[a].hasOwnProperty(c.WILDCARD))
						}, f.cannot = function(a) {
							return !this.can(a)
						}, f.transitions = function() {
							return(j[this.current] || []).concat(j[c.WILDCARD] || [])
						}, f.isFinished = function() {
							return this.is(e)
						}, f.error = a.error || function(a, b, c, d, e, f, g) {
							throw g || f
						}, f.states = function() {
							return Object.keys(j).sort()
						}, d && !d.defer && f[d.event](), f
					},
					doCallback: function(a, b, d, e, f, g) {
						if(b) try {
							return b.apply(a, [d, e, f].concat(g))
						} catch(b) {
							return a.error(d, e, f, g, c.Error.INVALID_CALLBACK, "an exception occurred in a caller-provided callback function", b)
						}
					},
					beforeAnyEvent: function(a, b, d, e, f) {
						return c.doCallback(a, a.onbeforeevent, b, d, e, f)
					},
					afterAnyEvent: function(a, b, d, e, f) {
						return c.doCallback(a, a.onafterevent || a.onevent, b, d, e, f)
					},
					leaveAnyState: function(a, b, d, e, f) {
						return c.doCallback(a, a.onleavestate, b, d, e, f)
					},
					enterAnyState: function(a, b, d, e, f) {
						return c.doCallback(a, a.onenterstate || a.onstate, b, d, e, f)
					},
					changeState: function(a, b, d, e, f) {
						return c.doCallback(a, a.onchangestate, b, d, e, f)
					},
					beforeThisEvent: function(a, b, d, e, f) {
						return c.doCallback(a, a["onbefore" + b], b, d, e, f)
					},
					afterThisEvent: function(a, b, d, e, f) {
						return c.doCallback(a, a["onafter" + b] || a["on" + b], b, d, e, f)
					},
					leaveThisState: function(a, b, d, e, f) {
						return c.doCallback(a, a["onleave" + d], b, d, e, f)
					},
					enterThisState: function(a, b, d, e, f) {
						return c.doCallback(a, a["onenter" + e] || a["on" + e], b, d, e, f)
					},
					beforeEvent: function(a, b, d, e, f) {
						if(!1 === c.beforeThisEvent(a, b, d, e, f) || !1 === c.beforeAnyEvent(a, b, d, e, f)) return !1
					},
					afterEvent: function(a, b, d, e, f) {
						c.afterThisEvent(a, b, d, e, f), c.afterAnyEvent(a, b, d, e, f)
					},
					leaveState: function(a, b, d, e, f) {
						var g = c.leaveThisState(a, b, d, e, f),
							h = c.leaveAnyState(a, b, d, e, f);
						return !1 !== g && !1 !== h && (c.ASYNC === g || c.ASYNC === h ? c.ASYNC : void 0)
					},
					enterState: function(a, b, d, e, f) {
						c.enterThisState(a, b, d, e, f), c.enterAnyState(a, b, d, e, f)
					},
					buildEvent: function(a, b) {
						return function() {
							var d = this.current,
								e = b[d] || (b[c.WILDCARD] != c.WILDCARD ? b[c.WILDCARD] : d) || d,
								f = Array.prototype.slice.call(arguments);
							if(this.transition) return this.error(a, d, e, f, c.Error.PENDING_TRANSITION, "event " + a + " inappropriate because previous transition did not complete");
							if(this.cannot(a)) return this.error(a, d, e, f, c.Error.INVALID_TRANSITION, "event " + a + " inappropriate in current state " + this.current);
							if(!1 === c.beforeEvent(this, a, d, e, f)) return c.Result.CANCELLED;
							if(d === e) return c.afterEvent(this, a, d, e, f), c.Result.NOTRANSITION;
							var g = this;
							this.transition = function() {
								return g.transition = null, g.current = e, c.enterState(g, a, d, e, f), c.changeState(g, a, d, e, f), c.afterEvent(g, a, d, e, f), c.Result.SUCCEEDED
							}, this.transition.cancel = function() {
								g.transition = null, c.afterEvent(g, a, d, e, f)
							};
							var h = c.leaveState(this, a, d, e, f);
							return !1 === h ? (this.transition = null, c.Result.CANCELLED) : c.ASYNC === h ? c.Result.PENDING : this.transition ? this.transition() : void 0
						}
					}
				};
				"undefined" != typeof b ? ("undefined" != typeof a && a.exports && (b = a.exports = c), b.StateMachine = c) : "function" == typeof g && g.amd ? g(function(a) {
					return c
				}) : "undefined" != typeof window ? window.StateMachine = c : "undefined" != typeof self && (self.StateMachine = c)
			}()
		}),
		dc = c(function(a) {
			var b = Ka,
			...
			q.prototype = {
				...
				getConstructor: function(a, d, h, j) {
					var k = a(function(a, b) {
						f(a, k, d, "_i"), a._i = o++, a._l = void 0, void 0 != b && g(b, h, a[j], a)
					});
					return b(k.prototype, {
						delete: function(a) {
							if(!e(a)) return !1;
							var b = c(a);
							return b === !0 ? p(this).delete(a) : b && i(b, this._i) && delete b[this._i]
						},
						has: function(a) {
							if(!e(a)) return !1;
							var b = c(a);
							return b === !0 ? p(this).has(a) : b && i(b, this._i)
						}
					}), k
				},
				def: function(a, b, e) {
					var f = c(d(b), !0);
					return f === !0 ? p(a).set(b, e) : f[a._i] = e, a
				},
				ufstore: p
			}
		}),
		ec = c(function(a) {
			var b = p,
				...
				q = ca(0),
				r = o;
			a.exports = function(a, j, n, o, p, s) {
				var t = b[a],
					u = t,
					v = p ? "set" : "add",
					w = u && u.prototype,
					x = {};
				return r && "function" == typeof u && (s || w.forEach && !e(function() {
					(new u).entries().next()
				})) ? (u = j(function(b, c) {
					i(b, u, a, "_c"), b._c = new t, void 0 != c && h(c, p, b[v], b)
				}), q("add,clear,delete,forEach,get,has,set,keys,values,entries,toJSON".split(","), function(a) {
					var b = "add" == a || "set" == a;
					a in w && (!s || "clear" != a) && f(u.prototype, a, function(c, d) {
						if(i(this, u, a), !b && s && !k(c)) return "get" == a && void 0;
						var e = this._c[a](0 === c ? 0 : c, d);
						return b ? this : e
					})
				}), "size" in w && m(u.prototype, "size", {
					get: function() {
						return this._c.size
					}
				})) : (u = o.getConstructor(j, a, p, v), g(u.prototype, n), d.NEED = !0), l(u, a), x[a] = u, c(c.G + c.W + c.F, x), s || o.setStrong(u, a, p), u
			}
		}),
		fc = (c(function(a) {
			var b, c = ca(0),
				...
				o = {
					get: function(a) {
						if(h(a)) {
							var b = i(a);
							return b === !0 ? l(this).get(a) : b ? b[this._i] : void 0
						}
					},
					set: function(a, b) {
				...
				p = a.exports = ec("WeakMap", n, o, g, !0, !0);
			7 != (new p).set((Object.freeze || Object)(m), 7).get(m) && (b = g.getConstructor(n), f(b.prototype, o), e.NEED = !0, c(["delete", "has", "get", "set"], function(a) {
				var c = p.prototype,
					e = c[a];
				d(c, a, function(c, d) {
					if(h(c) && !k(c)) {
			...
			c(c.S + c.F * !Ma(function(a) {
				...
				from: function(a) {
					var c, j, k, l, m = d(a),
						...
						r = 0,
						s = i(m);
					if(q && (p = b(p, o > 2 ? arguments[2] : void 0, 2)), void 0 == s || n == Array && f(s))
						for(c = g(m.length), j = new n(c); c > r; r++) h(j, r, q ? p(m[r], r) : m[r]);
					else
						for(l = s.call(m), j = new n; !(k = l.next()).done; r++) h(j, r, q ? e(l, p, [k.value, r], !0) : k.value);
					return j.length = r, j
				}
			})
		}), c(function(a) {
			a.exports = v.Array.from
		})),
		kc = c(function(a) {
			a.exports = {
				default: jc,
		...
		oc = c(function(a) {
			...
			a.exports = {
				getConstructor: function(a, i, j, k) {
					var m = a(function(a, b) {
						f(a, m, i, "_i"), a._i = c(null), a._f = void 0, a._l = void 0, a[n] = 0, void 0 != b && h(b, j, a[k], a)
					});
					return d(m.prototype, {
						clear: function() {
							for(var a = this, b = a._i, c = a._f; c; c = c.n) c.r = !0, c.p && (c.p = c.p.n = void 0), delete b[c.i];
							a._f = a._l = void 0, a[n] = 0
						},
						delete: function(a) {
							var b = this,
								c = p(b, a);
							if(c) {
								var d = c.n,
									e = c.p;
								delete b._i[c.i], c.r = !0, e && (e.n = d), d && (d.p = e), b._f == c && (b._f = d), b._l == c && (b._l = e), b[n]--
							}
							return !!c
						},
						forEach: function(a) {
							f(this, m, "forEach");
							for(var b, c = e(a, arguments.length > 1 ? arguments[1] : void 0, 3); b = b ? b.n : this._f;)
								for(c(b.v, b.k, this); b && b.r;) b = b.p
						},
						has: function(a) {
							return !!p(this, a)
						}
					}), l && b(m.prototype, "size", {
						get: function() {
							return g(this[n])
						}
					}), m
				...
				def: function(a, b, c) {
					...
					return f ? f.v = c : (a._l = f = {
						...
						n: void 0,
						r: !1
					}, a._f || (a._f = f), d && (d.n = f), a[n]++, "F" !== e && (a._i[e] = f)), a
				},
				getEntry: p,
				setStrong: function(a, b, c) {
					i(a, b, function(a, b) {
						...
						return a._t && (a._l = c = c ? c.n : a._t._f) ? "keys" == b ? j(0, c.k) : "values" == b ? j(0, c.v) : j(0, [c.k, c.v]) : (a._t = void 0, j(1))
		...
		qc = c(function(a) {
			...
			a.exports = function(a) {
				return function() {
					if(b(this) != a) throw TypeError(a + "#toJSON isn't generic");
					return c(this)
				}
			}
		}),
		...
		yc = b(xc),
		zc = c(function(a) {
			var b = "object" == typeof i && i && i.Object === Object && i;
			a.exports = b
		}),
		Ac = c(function(a) {
			var b = zc,
		...
		Ec = c(function(a) {
			function b(a) {
				return null == a ? void 0 === a ? g : f : (a = Object(a), h && h in a ? d(a) : e(a))
			}
			var c = Bc,
				d = Cc,
				e = Dc,
		...
		Gc = c(function(a) {
			var b = Fc,
				c = b(Object.getPrototypeOf, Object);
			a.exports = c
		}),
		Hc = c(function(a) {
			function b(a) {
		...
		Ic = c(function(a) {
			function b(a) {
				if(!e(a) || c(a) != f) return !1;
				var b = d(a);
				if(null === b) return !0;
				var g = j.call(b, "constructor") && b.constructor;
				return "function" == typeof g && g instanceof g && i.call(g) == k
			}
			var c = Ec,
				d = Gc,
				e = Hc,
		...
		Jc = "undefined" != typeof global ? global : "undefined" != typeof window ? window : {},
		Kc = c(function(a, b) {
			function c(a) {
				return a && a.__esModule ? a : {
					default: a
			...
			b.default = function() {
				function a(a, b) {
					for(var c = 0; c < b.length; c++) {
						var d = b[c];
						d.enumerable = d.enumerable || !1, d.configurable = !0, "value" in d && (d.writable = !0), (0, e.default)(a, d.key, d)
					}
				}
		...
		Oc = function() {
			function a(b, c) {
				Wa(this, a), this._value = b, "number" == typeof c && (this.expiredAt = Date.now() + c)
			}
			return Lc(a, [{
				key: "value",
				get: function() {
					var a = this.expiredAt && this.expiredAt < Date.now();
					return a && Nc("expired: " + this._value), a ? Mc : this._value
				}
			}]), a
		}();
	Oc.EXPIRED = Mc;
	var Pc, Qc = sb("LC:Cache"),
		Rc = function() {
			function a() {
				var b = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "anonymous";
				Wa(this, a), this.name = b, this._map = {}
			}
			return a.prototype.get = function(a) {
				var b = this._map[a];
				if(b) {
					var c = b.value;
					if(c !== Oc.EXPIRED) return Qc("[" + this.name + "] hit: " + a + " " + b.value), b.value;
					delete this._map[a]
				}
				return Qc("[" + this.name + "] missed: " + a), null
			}, a.prototype.set = function(a, b, c) {
				Qc("[" + this.name + "] set: " + a + " " + b + " " + c), this._map[a] = new Oc(b, c)
			}, a
		}(),
		Sc = function a(b) {
			var c = new Pa(b[0]);
			return 1 === b.length ? c : c.catch(function() {
				return a(b.slice(1))
			})
		},
		Tc = function(a) {
		...
		Uc = function(a) {
			return a ? "string" == typeof a ? new Date(a) : "Date" === a.__type && a.iso ? new Date(a.iso) : a : a
		},
		Vc = function(a, b) {
			return yc(b).reduce(function(c, d) {
				var e = a[d] || d;
				return Ua(c, vc({}, e, b[d]))
			}, {})
		},
		Wc = Jc.navigator && Jc.navigator.userAgent && Jc.navigator.userAgent.indexOf("MSIE 10.") !== -1,
		Xc = function a(b, c) {
			return b[c] || (b.__proto__ ? a(b.__proto__, c) : void 0)
		},
		Yc = function(a, b) {
			return lc(new tc([].concat(nc(a), nc(b))))
		},
		Zc = function(a, b) {
			return lc(function(b) {
				return new tc(a.filter(function(a) {
					return !b.has(a)
				}))
			}(new tc(b)))
		},
		$c = new hc,
		_c = function(a) {
			return $c.has(a) || $c.set(a, {}), $c.get(a)
		},
		ad = function a(b) {
			if(!Ic(b)) return b;
			var c = Ua({}, b);
			for(var d in c)
				if({}.hasOwnProperty.call(c, d)) {
					var e = c[d];
					null === e ? delete c[d] : c[d] = a(e)
				}
			return c
		},
		bd = function(a) {
			return ad(JSON.parse(yb(a)))
		},
		cd = function(a) {
			return Array.isArray(a) ? a : void 0 === a || null === a ? [] : [a]
		},
		dd = function(a, b, c) {
			var d = b.split("."),
				e = d.pop(),
			...
			return d.forEach(function(a) {
				void 0 === f[a] && (f[a] = {}), f = f[a]
			}), f[e] = c, a
		},
		ed = "object" === ("undefined" == typeof wx ? "undefined" : gb(wx)) && "function" == typeof wx.connectSocket,
		fd = Jc.WebSocket || Jc.MozWebSocket,
		gd = sb("LC:WebSocketPlus"),
		hd = 6e4,
		id = 18e4,
		jd = function(a) {
			return Math.min(1e3 * Math.pow(2, a), 3e5)
		},
		kd = function(a, b, c) {
			return Ua({}, c, {
				value: function() {
					...
					if(!this.is("connected")) {
						var d = this.current;
						throw console.warn(b + " should not be called when the connection is " + d), (this.is("offline") || this.is("reconnecting")) && console.warn("disconnect and reconnect event should be handled to avoid such calls."), new Error("Connection unavailable")
					}
					for(var e = arguments.length, f = Array(e), g = 0; g < e; g++) f[g] = arguments[g];
					return(a = c.value).call.apply(a, [this].concat(f))
				}
			})
		},
		ld = (Pc = function(a) {
			function b(c, d) {
				if(Wa(this, b), gd("initializing WebSocketPlus"), "undefined" == typeof fd) throw new Error("WebSocket is undefined. Polyfill is required in this runtime.");
				var e = ib(this, a.call(this));
				return "function" != typeof c ? e._getUrls = function() {
					return Pa.resolve(c)
				} : e._getUrls = c, e._protocol = d, e.init(), e._createWs(e._getUrls, e._protocol).then(function() {
					return e.open()
				}, function(a) {
					return e.throw(a)
				}).catch(e.throw.bind(e)), e.__postponeTimers = e._postponeTimers.bind(e), e
			}
			return pb(b, a), b.prototype._createWs = function(a, b) {
				var c = this;
				return a().then(function(a) {
					var d = a;
					return d instanceof Array || (d = [d]), Sc(d.map(function(a) {
						return function(d, e) {
							gd("connect [" + a + "] " + b);
							var f = b ? new fd(a, b) : new fd(a);
							f.binaryType = c.binaryType || "arraybuffer", f.onopen = function() {
								return d(f)
							}, f.onerror = f.onclose = function(b) {
								return e(b instanceof Error ? b : new Error("Failed to connect [" + a + "]"))
							}
						}
					})).then(function(a) {
						return c._ws = a, c._ws.onclose = c._handleClose.bind(c), c._ws.onmessage = c._handleMessage.bind(c), a
					})
				})
			}, b.prototype._destroyWs = function() {
				var a = this._ws;
				a && (a.onopen = a.onclose = a.onerror = a.onmessage = null, this._ws = null, a.close())
			}, b.prototype.onopen = function() {
				gd("open"), this.emit("open")
			}, b.prototype.onconnected = function() {
				this._startConnectionKeeper()
			}, b.prototype.onleaveconnected = function() {
				this._stopConnectionKeeper()
			}, b.prototype.onbeforedisconnect = function() {
				gd("disconnect"), this.emit("disconnect")
			}, b.prototype.ondisconnect = function() {
				this._destroyWs()
			}, b.prototype.onreconnect = function() {
				gd("reconnect"), this.emit("reconnect")
			}, b.prototype.onoffline = function(a, b, c) {
				var d = this,
					e = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0,
					f = jd.call(null, e);
				gd("schedule attempt=" + e + " delay=" + f), this.emit("schedule", e, f), this.__scheduledRetry && clearTimeout(this.__scheduledRetry), this.__scheduledRetry = setTimeout(function() {
					d.is("offline") && d.retry(e);
				}, f)
			}, b.prototype.onretry = function(a, b, c) {
				var d = this,
					e = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0;
				gd("retry attempt=" + e), this.emit("retry", e), this._createWs(this._getUrls, this._protocol).then(function() {
					return d.reconnect()
				}, function() {
					return d.fail(e + 1)
				})
			}, b.prototype.onclose = function() {
				gd("close"), this._ws && this._ws.close()
			}, b.prototype.onerror = function(a, b, c, d) {
				gd("error", d), this.emit("error", d)
			}, b.prototype._ping = function() {
				gd("ping");
				try {
					this.ping()
				} catch(a) {
					console.warn("websocket ping error: " + a.message)
				}
			...
			}, b.prototype._postponeTimers = function() {
				var a = this;
				gd("_postponeTimers"), this._clearTimers(), this._heartbeatTimer = setInterval(this._ping.bind(this), hd), this._timeoutTimer = setTimeout(function() {
					gd("timeout"), a.disconnect()
				}, id)
			}, b.prototype._clearTimers = function() {
				this._heartbeatTimer && clearInterval(this._heartbeatTimer), this._timeoutTimer && clearTimeout(this._timeoutTimer)
			}, b.prototype._startConnectionKeeper = function() {
				gd("start connection keeper");
				var a = this._ws.addListener || this._ws.addEventListener;
				a.call(this._ws, "message", this.__postponeTimers), this._postponeTimers()
			}, b.prototype._stopConnectionKeeper = function() {
				gd("stop connection keeper");
				var a = this._ws.removeListener || this._ws.removeEventListener;
				a.call(this._ws, "message", this.__postponeTimers), this._clearTimers()
			}, b.prototype._handleClose = function(a) {
				gd("ws closed [" + a.code + "] " + a.reason), this.isFinished() || this.handleClose(a)
			}, b.prototype.handleClose = function() {
				this.disconnect()
			}, b.prototype.send = function(a) {
				gd("send", a), this._ws.send(a)
			}, b.prototype._handleMessage = function(a) {
				gd("message", a.data), this.handleMessage(a.data)
			}, b.prototype.handleMessage = function(a) {
				this.emit("message", a)
			}, b
		}(tb), d(Pc.prototype, "_ping", [kd], bc(Pc.prototype, "_ping"), Pc.prototype), d(Pc.prototype, "send", [kd], bc(Pc.prototype, "send"), Pc.prototype), Pc);
	cc.create({
		target: ld.prototype,
		initial: {
			state: "initialized",
	...
	var md, nd = E({
		...
		od = E(yc(nd).reduce(function(a, b) {
			return Ua(a, vc({}, nd[b].name, Number(b)))
		}, {})),
		pd = function(a) {
			var b = a.code,
				c = a.reason,
				...
				e = a.detail,
				f = c || e;
			!f && nd[b] && (f = nd[b].message || nd[b].name), f || (f = "Unknow Error: " + b);
			var g = new Error(f);
			return Ua(g, {
				code: b,
				appCode: d,
		...
		qd = c(function(a) {
			! function(b, c) {
				"function" == typeof g && g.amd ? g([], c) : "object" == typeof a && a && a.exports ? a.exports = c() : (b.dcodeIO = b.dcodeIO || {}).Long = c()
			}(i, function() {
				function a(a, b, c) {
				...
				function c(a, b) {
					var c, d, f;
					return b ? (a >>>= 0, (f = 0 <= a && a < 256) && (d = i[a]) ? d : (c = e(a, (0 | a) < 0 ? -1 : 0, !0), f && (i[a] = c), c)) : (a |= 0, (f = -128 <= a && a < 128) && (d = h[a]) ? d : (c = e(a, a < 0 ? -1 : 0, !1), f && (h[a] = c), c))
				}

				function d(a, b) {
					if(isNaN(a) || !isFinite(a)) return b ? q : p;
					if(b) {
						if(a < 0) return q;
						if(a >= m) return v
					} else {
					...
					return a < 0 ? d(-a, b).neg() : e(a % l | 0, a / l | 0, b)
				}
				...
				function f(a, b, c) {
					...
					if("NaN" === a || "Infinity" === a || "+Infinity" === a || "-Infinity" === a) return p;
					if("number" == typeof b ? (c = b, b = !1) : b = !!b, c = c || 10, c < 2 || 36 < c) throw RangeError("radix");
					var e;
					if((e = a.indexOf("-")) > 0) throw Error("interior hyphen");
					if(0 === e) return f(a.substring(1), b, c).neg();
					for(var g = d(j(c, 8)), h = p, i = 0; i < a.length; i += 8) {
						var k = Math.min(8, a.length - i),
							l = parseInt(a.substring(i, i + k), c);
						if(k < 8) {
							var m = d(j(c, k));
							h = h.mul(m).add(d(l))
						} else h = h.mul(g), h = h.add(d(l))
					}
					return h.unsigned = b, h
				}

				function g(b) {
					return b instanceof a ? b : "number" == typeof b ? d(b) : "string" == typeof b ? f(b) : e(b.low, b.high, b.unsigned)
				}
				...
				var h = {},
					i = {};
				a.fromInt = c, a.fromNumber = d, a.fromBits = e;
				var j = Math.pow;
				a.fromString = f, a.fromValue = g;
				var k = 1 << 24,
					l = 4294967296,
				...
				return x.toInt = function() {
					...
					if(a = a || 10, a < 2 || 36 < a) throw RangeError("radix");
					...
					if(this.isNegative()) {
						if(this.eq(w)) {
							var b = d(a),
								c = this.div(b),
								e = c.mul(b).sub(this);
							return c.toString(a) + e.toInt().toString(a)
						}
						return "-" + this.neg().toString(a)
					}
					for(var f = d(j(a, 6), this.unsigned), g = this, h = "";;) {
						var i = g.div(f),
							k = g.sub(i.mul(f)).toInt() >>> 0,
							l = k.toString(a);
						if(g = i, g.isZero()) return l + h;
					...
					return b(a) || (a = g(a)), (this.unsigned === a.unsigned || this.high >>> 31 !== 1 || a.high >>> 31 !== 1) && (this.high === a.high && this.low === a.low)
				}, x.eq = x.equals, x.notEquals = function(a) {
					return !this.eq(a)
				}, x.neq = x.notEquals, x.lessThan = function(a) {
					return this.comp(a) < 0
				}, x.lt = x.lessThan, x.lessThanOrEqual = function(a) {
					return this.comp(a) <= 0
				}, x.lte = x.lessThanOrEqual, x.greaterThan = function(a) {
					return this.comp(a) > 0
				}, x.gt = x.greaterThan, x.greaterThanOrEqual = function(a) {
					return this.comp(a) >= 0
				}, x.gte = x.greaterThanOrEqual, x.compare = function(a) {
					if(b(a) || (a = g(a)), this.eq(a)) return 0;
					...
					return !this.unsigned && this.eq(w) ? w : this.not().add(r)
				}, x.neg = x.negate, x.add = function(a) {
					b(a) || (a = g(a));
					var c = this.high >>> 16,
						d = 65535 & this.high,
						f = this.low >>> 16,
						...
						o = 0,
						p = 0;
					return p += h + l, o += p >>> 16, p &= 65535, o += f + k, n += o >>> 16, o &= 65535, n += d + j, m += n >>> 16, n &= 65535, m += c + i, m &= 65535, e(o << 16 | p, m << 16 | n, this.unsigned)
				}, x.subtract = function(a) {
					return b(a) || (a = g(a)), this.add(a.neg())
				}, x.sub = x.subtract, x.multiply = function(a) {
					if(this.isZero()) return p;
					if(b(a) || (a = g(a)), a.isZero()) return p;
					if(this.eq(w)) return a.isOdd() ? w : p;
					if(a.eq(w)) return this.isOdd() ? w : p;
					if(this.isNegative()) return a.isNegative() ? this.neg().mul(a.neg()) : this.neg().mul(a).neg();
					if(a.isNegative()) return this.mul(a.neg()).neg();
					if(this.lt(o) && a.lt(o)) return d(this.toNumber() * a.toNumber(), this.unsigned);
					var c = this.high >>> 16,
						f = 65535 & this.high,
						h = this.low >>> 16,
						i = 65535 & this.low,
						...
						r = 0,
						s = 0;
					return s += i * m, r += s >>> 16, s &= 65535, r += h * m, q += r >>> 16, r &= 65535, r += i * l, q += r >>> 16, r &= 65535, q += f * m, n += q >>> 16, q &= 65535, q += h * l, n += q >>> 16, q &= 65535, q += i * k, n += q >>> 16, q &= 65535, n += c * m + f * l + h * k + i * j, n &= 65535, e(r << 16 | s, n << 16 | q, this.unsigned)
				}, x.mul = x.multiply, x.divide = function(a) {
					if(b(a) || (a = g(a)), a.isZero()) throw Error("division by zero");
					if(this.isZero()) return this.unsigned ? q : p;
					var c, e, f;
					if(this.unsigned) {
						if(a.unsigned || (a = a.toUnsigned()), a.gt(this)) return q;
						if(a.gt(this.shru(1))) return s;
						f = q
					} else {
						if(this.eq(w)) {
							if(a.eq(r) || a.eq(t)) return w;
							if(a.eq(w)) return r;
							var h = this.shr(1);
							return c = h.div(a).shl(1), c.eq(p) ? a.isNegative() ? r : t : (e = this.sub(a.mul(c)), f = c.add(e.div(a)))
						}
						if(a.eq(w)) return this.unsigned ? q : p;
						if(this.isNegative()) return a.isNegative() ? this.neg().div(a.neg()) : this.neg().div(a).neg();
						if(a.isNegative()) return this.div(a.neg()).neg();
						f = p
					}
					for(e = this; e.gte(a);) {
						c = Math.max(1, Math.floor(e.toNumber() / a.toNumber()));
						for(var i = Math.ceil(Math.log(c) / Math.LN2), k = i <= 48 ? 1 : j(2, i - 48), l = d(c), m = l.mul(a); m.isNegative() || m.gt(e);) c -= k, l = d(c, this.unsigned), m = l.mul(a);
						l.isZero() && (l = r), f = f.add(l), e = e.sub(m)
					}
					return f
				}, x.div = x.divide, x.modulo = function(a) {
					return b(a) || (a = g(a)), this.sub(this.div(a).mul(a))
				}, x.mod = x.modulo, x.not = function() {
					return e(~this.low, ~this.high, this.unsigned)
				}, x.and = function(a) {
					return b(a) || (a = g(a)), e(this.low & a.low, this.high & a.high, this.unsigned)
				}, x.or = function(a) {
					return b(a) || (a = g(a)), e(this.low | a.low, this.high | a.high, this.unsigned)
				}, x.xor = function(a) {
					return b(a) || (a = g(a)), e(this.low ^ a.low, this.high ^ a.high, this.unsigned)
				}, x.shiftLeft = function(a) {
					return b(a) && (a = a.toInt()), 0 === (a &= 63) ? this : a < 32 ? e(this.low << a, this.high << a | this.low >>> 32 - a, this.unsigned) : e(0, this.low << a - 32, this.unsigned)
				}, x.shl = x.shiftLeft, x.shiftRight = function(a) {
					return b(a) && (a = a.toInt()), 0 === (a &= 63) ? this : a < 32 ? e(this.low >>> a | this.high << 32 - a, this.high >> a, this.unsigned) : e(this.high >> a - 32, this.high >= 0 ? 0 : -1, this.unsigned)
				}, x.shr = x.shiftRight, x.shiftRightUnsigned = function(a) {
					if(b(a) && (a = a.toInt()), a &= 63, 0 === a) return this;
					var c = this.high;
					if(a < 32) {
						var d = this.low;
						return e(d >>> a | c << 32 - a, c >>> a, this.unsigned)
					}
					return 32 === a ? e(c, 0, this.unsigned) : e(c >>> a - 32, 0, this.unsigned)
				...
				}, x.toBytes = function(a) {
					return a ? this.toBytesLE() : this.toBytesBE()
				}, x.toBytesLE = function() {
					var a = this.high,
						b = this.low;
					return [255 & b, b >>> 8 & 255, b >>> 16 & 255, b >>> 24 & 255, 255 & a, a >>> 8 & 255, a >>> 16 & 255, a >>> 24 & 255]
				}, x.toBytesBE = function() {
					var a = this.high,
						b = this.low;
					return [a >>> 24 & 255, a >>> 16 & 255, a >>> 8 & 255, 255 & a, b >>> 24 & 255, b >>> 16 & 255, b >>> 8 & 255, 255 & b]
				}, a
			})
		}),
		rd = c(function(a) {
			! function(b, c) {
				"function" == typeof g && g.amd ? g(["long"], c) : "object" == typeof a && a && a.exports ? a.exports = function() {
					var a;
					try {
						a = qd
					} catch(a) {}
					return c(a)
				}() : (b.dcodeIO = b.dcodeIO || {}).ByteBuffer = c(b.dcodeIO.Long)
			}(i, function(a) {
				function b(a) {
					var b = 0;
					return function() {
				...
				var g = f.prototype;
				g.__isByteBuffer__, Object.defineProperty(g, "__isByteBuffer__", {
					value: !0,
					enumerable: !1,
					configurable: !1
				});
				...
				f.accessor = function() {
					...
					if(!this.noAssert) {
						...
						for(e = 0; e < f; ++e)
							if(0 === a.charCodeAt(e)) throw RangeError("Illegal str: Contains NULL-characters");
						if("number" != typeof c || c % 1 !== 0) throw TypeError("Illegal offset: " + c + " (not an integer)");
						if(c >>>= 0, c < 0 || c + 0 > this.buffer.byteLength) throw RangeError("Illegal offset: 0 <= " + c + " (+0) <= " + this.buffer.byteLength)
					}
				...
				var j = function() {
					...
					return a.encode = function(a, c) {
						...
						for(var e, f, g; null !== (e = a());)
							if(f = c[e], "undefined" == typeof f && d(e), null !== (e = a()) && (g = c[e], "undefined" == typeof g && d(e), b(f << 2 >>> 0 | (48 & g) >> 4), null !== (e = a()))) {
		...
		vd = c(function(a) {
			! function(b, c) {
				"function" == typeof g && g.amd ? g(["bytebuffer"], c) : "object" == typeof a && a && a.exports ? a.exports = c(rd, !0) : (b.dcodeIO = b.dcodeIO || {}).ProtoBuf = c(b.dcodeIO.ByteBuffer)
			}(i, function(a, b) {
				var c = {};
				return c.ByteBuffer = a, c.Long = a.Long || null, c.VERSION = "5.0.1", c.WIRE_TYPES = {}, c.WIRE_TYPES.VARINT = 0, c.WIRE_TYPES.BITS64 = 1, c.WIRE_TYPES.LDELIM = 2, c.WIRE_TYPES.STARTGROUP = 3, c.WIRE_TYPES.ENDGROUP = 4, c.WIRE_TYPES.BITS32 = 5, c.PACKABLE_WIRE_TYPES = [c.WIRE_TYPES.VARINT, c.WIRE_TYPES.BITS64, c.WIRE_TYPES.BITS32], c.TYPES = {
					...
					var a = {};
					return a.IS_NODE = !("object" != typeof h || h + "" != "[object process]" || h.browser), a.XHR = function() {
						for(var a = [function() {
					...
					function e(a, c) {
						...
						switch(f) {
							case b.WIRE_TYPES.VARINT:
								do d = c.readUint8(); while (128 === (128 & d));
								break;
					...
					var i = function(a, b, c, d, e) {
						...
						j = i.prototype = Object.create(g.prototype);
					j.getChildren = function(a) {
						...
						if(b = this.getChild(a.name))
							if(b instanceof m.Field && b.name !== b.originalName && null === this.getChild(b.originalName)) b.name = b.originalName;
							else {
					...
					var m = function(a, b, c, d, e, f) {
						...
						n = m.prototype = Object.create(i.prototype);
					n.build = function(c) {
						...
						var d = function(b, c) {
							...
							var e = c.getChildren(b.Reflect.Message.Field),
								...
								g = function(d, h) {
									...
									if(arguments.length > 0) {
										var l;
										if(1 !== arguments.length || null === d || "object" != typeof d || !("function" != typeof d.encode || d instanceof g) || Array.isArray(d) || d instanceof b.Map || a.isByteBuffer(d) || d instanceof ArrayBuffer || b.Long && d instanceof b.Long)
											for(i = 0, j = arguments.length; i < j; ++i) "undefined" != typeof(l = arguments[i]) && this.$set(e[i].name, l);
										else this.$set(d)
									}
								},
							...
							for(var i = 0; i < e.length; i++) {
								var j = e[i];
								j instanceof b.Reflect.Message.ExtensionField || c.builder.options.populateAccessors && function(a) {
						...
						for(var e, f = 0, g = this.children.length; f < g; f++)
							if(e = this.children[f], e instanceof s || e instanceof m || e instanceof w) {
						...
						for(var o = 0, p = this._fields.length; o < p; ++o)
							if(i = this._fields[o], null === k[i.name])
								if("proto3" === this.syntax) k[i.name] = i.defaultValue;
								else {
									if(i.required) {
					...
					var o = function(a, c, d, e, f, h, i, j, k, l) {
						...
						p = o.prototype = Object.create(g.prototype);
					p.build = function() {
						this.element = new k(this.type, this.resolvedType, !1, this.syntax), this.map && (this.keyElement = new k(this.keyType, void 0, !0, this.syntax)), "proto3" !== this.syntax || this.repeated || this.map ? "undefined" != typeof this.options.default && (this.defaultValue = this.verifyValue(this.options.default)) : this.defaultValue = k.defaultFieldValue(this.type)
						...
						try {
							if(this.repeated) {
								...
								if(this.options.packed && b.PACKABLE_WIRE_TYPES.indexOf(this.type.wireType) >= 0) {
									...
									for(f = 0; f < c.length; f++) d.writeVarint32(this.id << 3 | this.type.wireType), this.element.encodeValue(this.id, c[f], d)
						...
						try {
							if(this.repeated) {
								...
								if(this.options.packed && b.PACKABLE_WIRE_TYPES.indexOf(this.type.wireType) >= 0) {
									...
									for(f = 0; f < c.length; f++) e += a.calculateVarint32(this.id << 3 | this.type.wireType), e += this.element.calculateLength(this.id, c[f])
					...
					q.prototype = Object.create(o.prototype), f.Message.ExtensionField = q;
					...
					u.prototype = Object.create(g.prototype), f.Enum.Value = u;
					var v = function(a, b, c, d) {
						g.call(this, a, b, c), this.field = d
					};
					v.prototype = Object.create(g.prototype), f.Extension = v;
					var w = function(a, b, c, d) {
							i.call(this, a, b, c, d), this.className = "Service", this.clazz = null
						},
						x = w.prototype = Object.create(i.prototype);
					x.build = function(c) {
						return this.clazz && !c ? this.clazz : this.clazz = function(b, c) {
							for(var d = function(a) {
									b.Builder.Service.call(this), this.rpcImpl = a || function(a, b, c) {
										setTimeout(c.bind(this, Error("Not implemented, see: https://github.com/dcodeIO/ProtoBuf.js/wiki/Services")), 0)
									}
								}, e = d.prototype = Object.create(b.Builder.Service.prototype), f = c.getChildren(b.Reflect.Service.RPCMethod), g = 0; g < f.length; g++) ! function(b) {
					...
					var y = function(a, b, c, d) {
						...
						z = y.prototype = Object.create(g.prototype);
					z.buildOpt = j.buildOpt, f.Service.Method = y;
					...
					return A.prototype = Object.create(y.prototype), f.Service.RPCMethod = A, f
					...
					return e.isMessage = function(a) {
						...
						var e = "/";
						if("string" == typeof c) {
							if(a.Util.IS_NODE && (c = ud.resolve(c)), this.files[c] === !0) return this.reset();
							this.files[c] = !0
						} else if("object" == typeof c) {
							var f = c.root;
							a.Util.IS_NODE && (f = ud.resolve(f)), (f.indexOf("\\") >= 0 || c.file.indexOf("\\") >= 0) && (e = "\\");
							var g = f + e + c.file;
				...
				}(c, c.Reflect), c.newBuilder = function(a) {
		...
		wd = c(function(a) {
			a.exports = vd.newBuilder({}).import({
		...
		xd = wd.push_server.messages,
		yd = xd.JsonObjectMessage,
		zd = xd.SessionCommand,
		Ad = xd.DirectCommand,
		Bd = xd.AckCommand,
		Cd = xd.ConvCommand,
		Dd = xd.LogsCommand,
		...
		Ld = function(a) {
			function b(c, d) {
				var e = d.format,
					f = d.version;
				Wa(this, b), Jd("initializing Connection");
				var g = "lc." + e + "." + f;
				if(ed) var h = ib(this, a.call(this, c().then(function(a) {
					return a.map(function(a) {
						return "" + a + (a.indexOf("?") === -1 ? "?" : "&") + "subprotocol=" + encodeURIComponent(g)
					})
				})));
				else var h = ib(this, a.call(this, c, g));
				return h._protocalFormat = e, h._commands = {}, h._serialId = 0, ib(h)
			}
			return pb(b, a), b.prototype.send = function(b) {
				var c = this,
					d = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
					e = void 0;
				d && (this._serialId += 1, e = this._serialId, b.i = e), Jd("¼", bd(b), "sent");
				var f = void 0;
				if("protobase64" === this._protocalFormat ? f = b.toBase64() : b.toBuffer ? f = b.toBuffer() : b.toArrayBuffer && (f = b.toArrayBuffer()), !f) throw new TypeError(b + " is not a GenericCommand");
				return a.prototype.send.call(this, f), d ? new Pa(function(a, d) {
					c._commands[e] = {
						resolve: a,
						reject: d
					}, setTimeout(function() {
						c._commands[e] && (Jd("?", bd(b), "timeout"), d(new Error("Command Timeout.")), delete c._commands[e])
					}, Kd)
				}) : Pa.resolve()
			}, b.prototype.handleMessage = function(a) {
				var b = void 0;
				try {
					b = Gd.decode(a), Jd("½", bd(b), "received")
				} catch(b) {
					console.warn("Decode message failed", a)
				}
				this.emit("allmessage", b);
				var c = b.i;
				c ? this._commands[c] ? (b.cmd === Hd.error ? this._commands[c].reject(pd(b.errorMessage)) : this._commands[c].resolve(b), delete this._commands[c]) : console.warn("Unexpected command received with serialId [" + c + "],\n         which have timed out or never been requested.") : b.cmd === Hd.error ? this.emit("error", pd(b.errorMessage)) : this.emit("message", b)
			}, b.prototype.ping = function() {
				return this.send(new Gd({
					cmd: "echo"
				})).catch(function(a) {
					return console.warn("ping failed:", a)
				})
			}, b
		}(ld),
		Md = function(a) {
			return function(b) {
				var c = b.constructor;
				return Pa.resolve(b).then(a).then(Tc(function(d) {
					return void 0 === d || null === d ? console.warn("Middleware[" + (a._pluginName || "anonymous plugin") + ":" + (a.name || "anonymous middleware") + "] param/return types not match. It returns " + d + " while a " + b.constructor.name + " expected.") : d instanceof c ? 0 : console.warn("Middleware[" + (a._pluginName || "anonymous plugin") + ":" + (a.name || "anonymous middleware") + "] param/return types not match. It returns a " + d.constructor.name + " while a " + b.constructor.name + " expected.")
				}))
			}
		},
		Nd = function(a, b) {
			a && a.forEach(function(a) {
				try {
					...
					throw a._pluginName && (b.message += "[" + a._pluginName + "]"), b
				}
			})
		},
		Od = function(a) {
			return function(b) {
				return cd(a).reduce(function(a, b) {
					return a.then(Md(b)).catch(function(a) {
						throw b._pluginName && (a.message += "[" + b._pluginName + "]"), a
					})
				}, Pa.resolve(b))
			}
		},
		...
		Wd = c(function(a) {
			function b(a) {
				if(!c(a)) return d(a);
				var b = [];
				for(var e in Object(a)) f.call(a, e) && "constructor" != e && b.push(e);
				return b
			}
			var c = Ud,
				d = Vd,
		...
		$d = c(function(a) {
			...
			var c = Zd,
				d = function() {
					var a = /[^.]+$/.exec(c && c.keys && c.keys.IE_PROTO || "");
		...
		ae = c(function(a) {
			...
			var c = Yd,
				...
				k = i.toString,
				l = j.hasOwnProperty,
				m = RegExp("^" + k.call(l).replace(g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
			a.exports = b
		}),
		be = c(function(a) {
			function b(a, b) {
		...
		ie = c(function(a) {
			var b = de,
				...
				s = h(f),
				t = g;
			(b && t(new b(new ArrayBuffer(1))) != n || c && t(new c) != i || d && t(d.resolve()) != k || e && t(new e) != l || f && t(new f) != m) && (t = function(a) {
				var b = g(a),
					c = b == j ? a.constructor : void 0,
					d = c ? h(c) : "";
				if(d) switch(d) {
					case o:
						return n;
		...
		ke = c(function(a) {
			var b = je,
				...
				g = b(function() {
					...
					return c(a) && e.call(a, "callee") && !f.call(a, "callee")
				};
			a.exports = g
		}),
		le = c(function(a) {
		...
		pe = c(function(a, b) {
			var c = Ac,
				...
				g = f && f.exports === e,
				h = g ? c.Buffer : void 0,
				i = h ? h.isBuffer : void 0,
				j = i || d;
			a.exports = j
		}),
		qe = c(function(a) {
			function b(a) {
				return e(a) && d(a.length) && !!D[c(a)]
			}
			var c = Ec,
				d = me,
				e = Hc,
				...
				D = {};
			D[u] = D[v] = D[w] = D[x] = D[y] = D[z] = D[A] = D[B] = D[C] = !0, D[f] = D[g] = D[s] = D[h] = D[t] = D[i] = D[j] = D[k] = D[l] = D[m] = D[n] = D[o] = D[p] = D[q] = D[r] = !1, a.exports = b
		}),
		re = c(function(a) {
			function b(a) {
				return function(b) {
		...
		se = c(function(a, b) {
			var c = zc,
				d = "object" == typeof b && b && !b.nodeType && b,
		...
		ue = c(function(a) {
			function b(a) {
				if(null == a) return !0;
				if(g(a) && (f(a) || "string" == typeof a || "function" == typeof a.splice || h(a) || j(a) || e(a))) return !a.length;
				var b = d(a);
				if(b == k || b == l) return !a.size;
				if(i(a)) return !c(a).length;
				for(var m in a)
					if(n.call(a, m)) return !1;
				return !0
			}
			var c = Wd,
				d = ie,
		...
		ye = c(function(a) {
			function b(a) {
				...
				if(d < 0) return !1;
				var f = b.length - 1;
				return d == f ? b.pop() : e.call(b, d, 1), --this.size, !0
			}
			var c = xe,
				d = Array.prototype,
				e = d.splice;
		...
		Be = c(function(a) {
			function b(a, b) {
				var d = this.__data__,
					e = c(d, a);
				return e < 0 ? (++this.size, d.push([a, b])) : d[e][1] = b, this
			}
			var c = xe;
			a.exports = b
		}),
		Ce = c(function(a) {
			...
			var c = ve,
				...
				f = Ae,
				g = Be;
			b.prototype.clear = c, b.prototype.delete = d, b.prototype.get = e, b.prototype.has = f, b.prototype.set = g, a.exports = b
		}),
		De = c(function(a) {
			function b() {
		...
		Le = c(function(a) {
			function b(a) {
				var b = this.__data__;
				return c ? void 0 !== b[a] : e.call(b, a)
			}
			var c = He,
				d = Object.prototype,
				e = d.hasOwnProperty;
		...
		Me = c(function(a) {
			function b(a, b) {
				var e = this.__data__;
				return this.size += this.has(a) ? 0 : 1, e[a] = c && void 0 === b ? d : b, this
			}
			var c = He,
				d = "__lodash_hash_undefined__";
			a.exports = b
		...
		Qe = c(function(a) {
			function b(a, b) {
				var d = a.__data__;
				return c(b) ? d["string" == typeof b ? "string" : "hash"] : d.map
			}
			var c = Pe;
			a.exports = b
		}),
		...
		Ue = c(function(a) {
			function b(a, b) {
				var d = c(this, a),
					e = d.size;
				return d.set(a, b), this.size += d.size == e ? 0 : 1, this
			}
			var c = Qe;
			a.exports = b
		}),
		...
		We = c(function(a) {
			function b(a, b) {
				...
				if(g instanceof c) {
					var h = g.__data__;
					if(!d || h.length < f - 1) return h.push([a, b]), this.size = ++g.size, this;
					g = this.__data__ = new e(h)
				}
		...
		Xe = c(function(a) {
			...
			var c = Ce,
				...
				g = Ge,
				h = We;
			b.prototype.clear = d, b.prototype.delete = e, b.prototype.get = f, b.prototype.has = g, b.prototype.set = h, a.exports = b
		}),
		Ye = c(function(a) {
			function b(a, b) {
		...
		_e = c(function(a) {
			function b(a, b, e) {
				var g = a[b];
				f.call(a, b) && d(g, e) && (void 0 !== e || b in a) || c(a, b, e)
			}
			var c = $e,
				d = we,
				e = Object.prototype,
		...
		af = c(function(a) {
			function b(a, b, e, f) {
				...
				for(var h = -1, i = b.length; ++h < i;) {
					var j = b[h],
						k = f ? f(e[j], a[j], j, e, a) : void 0;
					void 0 === k && (k = a[j]), g ? d(e, j, k) : c(e, j, k)
				}
				return e
			}
			var c = _e,
		...
		cf = c(function(a) {
			function b(a, b) {
				return b = null == b ? c : b, !!b && ("number" == typeof a || d.test(a)) && a > -1 && a % 1 == 0 && a < b
			}
			var c = 9007199254740991,
				d = /^(?:0|[1-9]\d*)$/;
			a.exports = b
		...
		df = c(function(a) {
			function b(a, b) {
				var i = e(a),
					...
					m = !i && !k && !l && h(a),
					n = i || k || l || m,
					o = n ? c(a.length, String) : [],
					p = o.length;
				for(var q in a) !b && !j.call(a, q) || n && ("length" == q || l && ("offset" == q || "parent" == q) || m && ("buffer" == q || "byteLength" == q || "byteOffset" == q) || g(q, p)) || o.push(q);
				return o
			}
			var c = bf,
				d = ke,
		...
		hf = c(function(a) {
			function b(a) {
				...
				var b = d(a),
					f = [];
				for(var h in a)("constructor" != h || !b && g.call(a, h)) && f.push(h);
				return f
			}
			var c = Xd,
				d = Ud,
		...
		wf = c(function(a) {
			function b(a) {
				var b = a.length,
					c = a.constructor(b);
				return b && "string" == typeof a[0] && d.call(a, "index") && (c.index = a.index, c.input = a.input), c
			}
			var c = Object.prototype,
				d = c.hasOwnProperty;
			a.exports = b
		...
		Df = c(function(a) {
			function b(a, b, g) {
				var h = b ? g(e(a), f) : e(a);
				return d(h, c, new a.constructor)
			}
			var c = Af,
				d = Bf,
				e = Cf,
		...
		Ef = c(function(a) {
			function b(a) {
				var b = new a.constructor(a.source, c.exec(a));
		...
		Nf = c(function(a) {
			function b(a, z, A, B, C, F) {
				var G, I = z & v,
					J = z & w,
					K = z & x;
				if(A && (G = C ? A(a, B, C, F) : A(a)), void 0 !== G) return G;
				if(!t(a)) return a;
				var L = r(a);
				if(L) {
					if(G = o(a), !I) return i(a, G)
				} else {
					var M = n(a),
						N = M == D || M == E;
					if(s(a)) return h(a, I);
					if(M == H || M == y || N && !C) {
						if(G = J || N ? {} : q(a), !I) return J ? k(a, g(G, a)) : j(a, f(G, a))
					} else {
						if(!Y[M]) return C ? a : {};
						G = p(a, M, b, I)
					}
				...
				if(O) return O;
				F.set(a, G);
				var P = K ? J ? m : l : J ? keysIn : u,
					Q = L ? void 0 : P(a);
				return d(Q || a, function(c, d) {
					Q && (d = c, c = a[d]), e(G, d, b(c, z, A, d, a, F))
				}), G
			}
			var c = Xe,
				d = Ye,
				...
				Y = {};
			Y[y] = Y[z] = Y[N] = Y[O] = Y[A] = Y[B] = Y[P] = Y[Q] = Y[R] = Y[S] = Y[T] = Y[F] = Y[G] = Y[H] = Y[I] = Y[J] = Y[K] = Y[L] = Y[U] = Y[V] = Y[W] = Y[X] = !0, Y[C] = Y[D] = Y[M] = !1, a.exports = b
		}),
		Of = c(function(a) {
			function b(a) {
				return c(a, d | e)
		...
		Pf = c(function(a, b) {
			...
			var d = Ta,
				e = c(d);
			b.default = e.default || function(a) {
		...
		Rf = c(function(a) {
			var b = Aa,
				c = _("iterator"),
				d = qa;
			a.exports = v.isIterable = function(a) {
				var e = Object(a);
				return void 0 !== e[c] || "@@iterator" in e || d.hasOwnProperty(b(e))
			}
		}),
		Sf = c(function(a) {
			a.exports = Rf
		...
		Uf = c(function(a) {
			var b = m,
				c = Ea;
			a.exports = v.getIterator = function(a) {
				var d = c(a);
				if("function" != typeof d) throw TypeError(a + " is not iterable!");
				return b(d.call(a))
			}
		}),
		Vf = c(function(a) {
			...
			b.default = function() {
				function a(a, b) {
					var c = [],
						...
						f = void 0;
					try {
						for(var h, i = (0, g.default)(a); !(d = (h = i.next()).done) && (c.push(h.value), !b || c.length !== b); d = !0);
					} catch(a) {
						e = !0, f = a
					} finally {
						try {
				...
				return function(b, c) {
					...
					if((0, e.default)(Object(b))) return a(b, c);
		...
		_f = c(function(a) {
			function b(a) {
				return "symbol" == typeof a || d(a) && c(a) == e
			}
			var c = Ec,
				d = Hc,
				e = "[object Symbol]";
		...
		bg = c(function(a) {
			function b(a, b, i) {
				...
				function k(a) {
					return y = a, w = setTimeout(n, b), z ? j(a) : v
				}
				...
				function o(a) {
					return w = void 0, B && s ? j(a) : (s = t = void 0, v)
				}
				...
				function r() {
					...
					if(s = arguments, t = this, x = a, c) {
						...
						if(A) return w = setTimeout(n, b), j(x)
					}
				...
				return b = e(b) || 0, c(i) && (z = !!i.leading, A = "maxWait" in i, u = A ? g(e(i.maxWait) || 0, b) : u, B = "trailing" in i ? !!i.trailing : B), r.cancel = p, r.flush = q, r
			}
			var c = Xd,
				d = $f,
				e = ag,
		...
		cg = c(function(a) {
			function b(a, b, f) {
				...
				return d(f) && (g = "leading" in f ? !!f.leading : g, h = "trailing" in f ? !!f.trailing : h), c(a, b, {
					leading: g,
					maxWait: b,
					trailing: h
				})
		...
		dg = function(a) {
			function b(c) {
				var d = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
					e = arguments[2],
					f = arguments[3];
				if(Wa(this, b), void 0 !== c && "string" != typeof c) throw new TypeError("Client id [" + c + "] is not a String");
				var g = ib(this, a.call(this));
				return Ua(g, {
					id: c,
					_connection: e,
					options: d
			...
			return pb(b, a), b.prototype._dispatchMessage = function(a) {
				this.emit("message", a)
			}, b
		}(tb),
		eg = sb("LC:ConversationQuery"),
		fg = function() {
			function a(b) {
				Wa(this, a), this._client = b, this._where = {}, this._extraOptions = {}
			}
			return a._encode = function(a) {
				return a instanceof Date ? {
					__type: "Date",
					iso: a.toJSON()
				} : a instanceof RegExp ? a.source : a
			}, a._quote = function(a) {
				return "\\Q" + a.replace("\\E", "\\E\\\\E\\Q") + "\\E"
			}, a._calculateFlag = function(a) {
				return ["withLastMessagesRefreshed", "compact"].reduce(function(b, c) {
					return(b << 1) + Boolean(a[c])
				}, 0)
			}, a.prototype._addCondition = function(a, b, c) {
				return this._where[a] || (this._where[a] = {}), this._where[a][b] = this.constructor._encode(c), this
			}, a.prototype.toJSON = function() {
				var a = {
					where: this._where,
					flag: this.constructor._calculateFlag(this._extraOptions)
				};
				return "undefined" != typeof this._skip && (a.skip = this._skip), "undefined" != typeof this._limit && (a.limit = this._limit), "undefined" != typeof this._order && (a.sort = this._order), eg(a), a
			}, a.prototype.containsMembers = function(a) {
				return this.containsAll("m", a)
			}, a.prototype.withMembers = function(a, b) {
				var c = new tc(a);
				return b && c.add(this._client.id), this.sizeEqualTo("m", c.size), this.containsMembers(lc(c))
			}, a.prototype.equalTo = function(a, b) {
				return this._where[a] = this.constructor._encode(b), this
			}, a.prototype.lessThan = function(a, b) {
				return this._addCondition(a, "$lt", b)
			}, a.prototype.lessThanOrEqualTo = function(a, b) {
				return this._addCondition(a, "$lte", b)
			}, a.prototype.greaterThan = function(a, b) {
				return this._addCondition(a, "$gt", b)
			}, a.prototype.greaterThanOrEqualTo = function(a, b) {
				return this._addCondition(a, "$gte", b)
			}, a.prototype.notEqualTo = function(a, b) {
				return this._addCondition(a, "$ne", b)
			}, a.prototype.containedIn = function(a, b) {
				return this._addCondition(a, "$in", b)
			}, a.prototype.notContainsIn = function(a, b) {
				return this._addCondition(a, "$nin", b)
			}, a.prototype.containsAll = function(a, b) {
				return this._addCondition(a, "$all", b)
			}, a.prototype.contains = function(b, c) {
				return this._addCondition(b, "$regex", a._quote(c))
			}, a.prototype.startsWith = function(b, c) {
				return this._addCondition(b, "$regex", "^" + a._quote(c))
			}, a.prototype.endsWith = function(b, c) {
				return this._addCondition(b, "$regex", a._quote(c) + "$")
			}, a.prototype.matches = function(a, b) {
				this._addCondition(a, "$regex", b);
				var c = "";
				return b.ignoreCase && (c += "i"), b.multiline && (c += "m"), c && c.length && this._addCondition(a, "$options", c), this
			}, a.prototype.sizeEqualTo = function(a, b) {
				return this._addCondition(a, "$size", b)
			}, a.prototype.limit = function(a) {
				return this._limit = a, this
			}, a.prototype.skip = function(a) {
				return this._skip = a, this
			}, a.prototype.ascending = function(a) {
				return this._order = a, this
			}, a.prototype.addAscending = function(a) {
				return this._order ? this._order += "," + a : this._order = a, this
			}, a.prototype.descending = function(a) {
				return this._order = "-" + a, this
			}, a.prototype.addDescending = function(a) {
				return this._order ? this._order += ",-" + a : this._order = "-" + a, this
			}, a.prototype.withLastMessagesRefreshed = function() {
				var a = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
				return this._extraOptions.withLastMessagesRefreshed = a, this
			}, a.prototype.withLastMessages = function(a) {
				return console.warn("DEPRECATION ConversationQuery#withLastMessages: Use ConversationQuery#withLastMessagesRefreshed instead."), this.withLastMessagesRefreshed(a)
			}, a.prototype.compact = function() {
				var a = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
				return this._extraOptions.compact = a, this
			}, a.prototype.find = function() {
				return this._client._executeQuery(this)
			}, a
		}(),
		gg = sb("LC:SignatureFactoryRunner"),
		hg = function(a, b) {
			return Pa.resolve().then(function() {
				return gg("call signatureFactory with " + b), a.apply(void 0, nc(b))
			}).then(Tc(function(a) {
				return gg("sign result", a)
			}), function(a) {
				throw a.message = "sign error: " + a.message, gg(a), a
			}).then(e)
		},
		ig = {
			NONE: eb("none"),
			SENDING: eb("sending"),
			SENT: eb("sent"),
			DELIVERED: eb("delivered"),
			FAILED: eb("failed")
		};
	E(ig);
	var jg, kg, lg, mg, ng, og = (md = {}, vc(md, ig.NONE, !0), vc(md, ig.SENDING, !0), vc(md, ig.SENT, !0), vc(md, ig.DELIVERED, !0), vc(md, ig.FAILED, !0), md),
		pg = function() {
			function a(b) {
				Wa(this, a), Ua(this, {
					content: b
					...
					needReceipt: !1,
					transient: !1
				}), this._setStatus(ig.NONE)
			}
			return a.prototype.setNeedReceipt = function(a) {
				return console.warn("DEPRECATION Message#setNeedReceipt: Use Conversation#send with sendOptions.reciept instead."), this.needReceipt = a, this
			}, a.prototype.setTransient = function(a) {
				return console.warn("DEPRECATION Message#setTransient: Use Conversation#send with sendOptions.transient instead."), this.transient = a, this
			}, a.prototype.toJSON = function() {
				return this.content
			}, a.prototype._setStatus = function(a) {
				if(!og[a]) throw new Error("Invalid message status");
				this._status = a
			}, a.validate = function() {
				return !0
		...
		sg = function(a) {
			function b() {
				...
				var f = ib(this, a.call.apply(a, [this].concat(d)));
				if(!f._messageParser) throw new Error("IMClient must be initialized with a MessageParser");
				return f._conversationCache = new Rc("client:" + f.id), f._ackMessageBuffer = {}, _c(f)._eventemitter = new tb, ["invited", "kicked", "membersjoined", "membersleft", "message", "unreadmessages", "close", "conflict", "unhandledmessage"].forEach(function(a) {
					return f.on(a, function() {
						for(var b = arguments.length, c = Array(b), d = 0; d < b; d++) c[d] = arguments[d];
						return f._debug.apply(f, [a + " event emitted."].concat(c))
					})
				}), Nd(f._plugins.onIMClientCreate, f), f
			}
			return pb(b, a), b.prototype._debug = function() {
				for(var a = arguments.length, b = Array(a), c = 0; c < a; c++) b[c] = arguments[c];
				rg.apply(void 0, b.concat(["[" + this.id + "]"]))
			}, b.prototype._dispatchMessage = function(a) {
				switch(this._debug(bd(a), "received"), a.cmd) {
					case Hd.conv:
						return this._dispatchConvMessage(a);
					case Hd.direct:
						return this._dispatchDirectMessage(a);
					case Hd.session:
						return this._dispatchSessionMessage(a);
					case Hd.unread:
						return this._dispatchUnreadMessage(a);
					case Hd.rcp:
						return this._dispatchRcpMessage(a);
					default:
						return this.emit("unhandledmessage", a), Pa.resolve()
				}
			}, b.prototype._dispatchSessionMessage = function(a) {
				var b = a.sessionMessage,
					c = b.code,
					d = b.reason;
				switch(a.op) {
					case Id.closed:
						return c === od.SESSION_CONFLICT ? this.emit("conflict", {
							reason: d
						}) : this.emit("close", {
							code: c,
							reason: d
					...
					default:
						return this.emit("unhandledmessage", a), Pa.reject(new Error("Unrecognized session command"))
				}
			}, b.prototype._dispatchUnreadMessage = function(a) {
				var b = this,
					c = a.unreadMessage.convs;
				return Pa.all(c.map(function(a) {
					return b.getConversation(a.cid).then(function(c) {
						var d = void 0;
						a.timestamp && (d = new Date(a.timestamp.toNumber()), c.lastMessageAt = d), c.unreadMessagesCount = a.unread, b.emit("unreadmessages", {
							count: a.unread,
							lastMessageId: a.mid,
			...
			}, b.prototype._dispatchRcpMessage = function(a) {
				var b = a.rcpMessage,
					c = b.cid,
					d = b.id,
					e = new Date(b.t.toNumber()),
					f = this._conversationCache.get(c);
				f && f._handleReceipt({
					messageId: d,
					deliveredAt: e
				})
			}, b.prototype._dispatchConvMessage = function(a) {
				var b = this,
					c = a.convMessage,
					d = a.convMessage,
					e = d.initBy,
				...
				switch(a.op) {
					case Id.joined:
						return this.getConversation(c.cid).then(function(a) {
							a.transient || (a.members = Yc(a.members, [b.id]));
							var c = {
								invitedBy: e
							};
							b.emit("invited", c, a), a.emit("invited", c)
						});
					case Id.left:
						return this.getConversation(c.cid).then(function(a) {
							a.transient || (a.members = Zc(a.members, [b.id]));
							var c = {
								kickedBy: e
							};
							b.emit("kicked", c, a), a.emit("kicked", c)
						});
					case Id.members_joined:
						return this.getConversation(c.cid).then(function(a) {
							a.transient || (a.members = Yc(a.members, c.m));
							var d = {
								invitedBy: e,
								members: f
							};
							b.emit("membersjoined", d, a), a.emit("membersjoined", d)
						});
					case Id.members_left:
						return this.getConversation(c.cid).then(function(a) {
							a.transient || (a.members = Zc(a.members, c.m));
							var d = {
								kickedBy: e,
								members: f
							};
							b.emit("membersleft", d, a), a.emit("membersleft", d)
						});
					default:
						return this.emit("unhandledmessage", a), Pa.reject(new Error("Unrecognized conversation command"))
				}
			}, b.prototype._dispatchDirectMessage = function(a) {
				var b = this,
					c = a.directMessage,
					d = a.directMessage,
					e = d.id,
					...
					h = d.timestamp,
					i = d.transient;
				return Pa.all([this.getConversation(c.cid), this._messageParser.parse(c.msg)]).then(function(a) {
					var c = Zf(a, 2),
						d = c[0],
						j = c[1],
						k = {
							id: e,
							cid: f,
							timestamp: new Date(h.toNumber()),
							from: g,
							transient: i
						};
					Ua(j, k), j._setStatus(ig.SENT), d.lastMessage = j, d.lastMessageAt = j.timestamp, d.unreadMessagesCount += 1, b.emit("message", j, d), d.emit("message", j), i || d.transient || b._sendAck(j)
				})
			}, b.prototype._sendAck = function(a) {
				this._debug("send ack for", a);
				var b = a.cid;
				return b ? (this._ackMessageBuffer[b] || (this._ackMessageBuffer[b] = []), this._ackMessageBuffer[b].push(a), this._doSendAckThrottled || (this._doSendAckThrottled = cg(this._doSendAck.bind(this), 1e3)), this._doSendAckThrottled()) : Pa.reject(new Error("missing cid"))
			}, b.prototype._doSendAck = function() {
				var a = this;
				return this._connection.is("connected") ? (rg("do send ack", this._ackMessageBuffer), Pa.all(yc(this._ackMessageBuffer).map(function(b) {
					var c = a._ackMessageBuffer[b],
						d = c.map(function(a) {
							return a.timestamp
						}),
						e = new Gd({
							...
							ackMessage: new Bd({
								cid: b,
								fromts: Math.min.apply(null, d),
								tots: Math.max.apply(null, d)
							})
						});
					return a._send(e, !1).then(function() {
						return delete a._ackMessageBuffer[b]
					}).catch(function(a) {
						return console.warn("send ack failed:", a)
					})
				}))) : Pa.resolve()
			}, b.prototype._send = function(a) {
				var b, c = a;
				this.id && (c.peerId = this.id);
				for(var d = arguments.length, e = Array(d > 1 ? d - 1 : 0), f = 1; f < d; f++) e[f - 1] = arguments[f];
				return(b = this._connection).send.apply(b, [c].concat(e))
			}, b.prototype._open = function(a, b, c) {
				var d = this,
					e = arguments.length > 3 && void 0 !== arguments[3] && arguments[3];
				return this._debug("open session"), Pa.resolve(new Gd({
					cmd: "session",
					op: "open",
					appId: a,
					sessionMessage: new zd({
						ua: "js/" + qg,
						r: e
					})
				})).then(function(a) {
					if(e) {
						var f = _c(d).sessionToken;
						if(f) {
							var g = f.value;
							if(g && g !== Oc.EXPIRED) return Ua(a.sessionMessage, {
								st: g
							}), a
						}
					}
					return Ua(a.sessionMessage, bd({
						tag: b,
						deviceId: c
					})), d.options.signatureFactory ? hg(d.options.signatureFactory, [d.id]).then(function(b) {
						return Ua(a.sessionMessage, Vc({
							signature: "s",
							timestamp: "t",
							nonce: "n"
						}, b)), a
					}) : a
				}).then(this._send.bind(this)).then(function(a) {
					var b = a.peerId,
						c = a.sessionMessage,
						e = c.st,
						f = c.stTtl;
					return b ? (d.id = b, void(e && (_c(d).sessionToken = new Oc(e, 1e3 * f)))) : void console.warn("Unexpected session opened without peerId.")
				}, function(f) {
					if(f.code === od.SESSION_TOKEN_EXPIRED) {
						if(void 0 === _c(d).sessionToken) throw new Error("Unexpected session expiration");
						return rg("Session token expired, reopening"), delete _c(d).sessionToken, d._open(a, b, c, e)
					}
					throw f
				})
				...
				return this._send(b).then(function() {
					_c(a)._eventemitter.emit("close", {
						code: 0
					}), a.emit("close", {
						code: 0
					})
				...
				if(this._debug("ping"), !(a instanceof Array)) throw new TypeError("clientIds " + a + " is not an Array");
				if(!a.length) return Pa.resolve([]);
				var b = new Gd({
					cmd: "session",
					op: "query",
					sessionMessage: new zd({
				...
				return this._send(b).then(function(a) {
					return a.sessionMessage.onlineSessionPeerIds
				})
			}, b.prototype.getConversation = function(a) {
				var b = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
				if("string" != typeof a) throw new TypeError(a + " is not a String");
				if(!b) {
					var c = this._conversationCache.get(a);
					if(c) return Pa.resolve(c)
				}
				return this.getQuery().equalTo("objectId", a).find().then(function(a) {
					return a[0] || null
				})
			}, b.prototype.getQuery = function() {
				return new fg(this)
			}, b.prototype._executeQuery = function(a) {
				var b = this,
					c = a.toJSON();
				c.where = new yd({
					data: yb(c.where)
				...
				var d = new Gd({
					cmd: "conv",
					op: "query",
					convMessage: new Cd(c)
				});
				return this._send(d).then(function(a) {
					try {
						return JSON.parse(a.convMessage.results.data)
					} catch(c) {
						var b = yb(bd(a));
						throw new Error("Parse query result failed: " + error$$1.message + ". Command: " + b)
					}
				}).then(function(a) {
					return Pa.all(a.map(b._parseConversationFromRawData.bind(b)))
				}).then(function(a) {
					return a.map(function(a) {
						var c = b._conversationCache.get(a.id);
						return c ? (b._debug("update cached conversation"), ["creator", "createdAt", "updatedAt", "lastMessageAt", "lastMessage", "mutedMembers", "members", "_attributes", "transient", "muted"].forEach(function(b) {
							var d = a[b];
							void 0 !== d && (c[b] = d)
						}), c._reset()) : (c = a, b._debug("no match, set cache"), b._conversationCache.set(a.id, a)), c
					})
				})
			}, b.prototype._parseConversationFromRawData = function(a) {
				var b = this,
					c = Vc({
						objectId: "id",
						lm: "lastMessageAt",
				...
				return Pa.resolve().then(function() {
					return c.lastMessage ? b._messageParser.parse(c.lastMessage).then(function(a) {
						c.lastMessage = a, c.lastMessage.from = c.lastMessageFrom, c.lastMessage.id = c.lastMessageId, c.lastMessage.timestamp = new Date(c.lastMessageTimestamp), c.lastMessage._setStatus(ig.SENT), delete c.lastMessageFrom, delete c.lastMessageId, delete c.lastMessageTimestamp
					}) : Pa.resolve()
				}).then(function() {
					return new ug(c, b)
				})
				...
				var a = this,
					...
					f = b.transient,
					g = b.unique,
					h = Td(b, ["members", "name", "attributes", "transient", "unique"]);
				if(!f && !Array.isArray(c)) throw new TypeError("conversation members " + c + " is not an array");
				var i = new tc(c);
				i.add(this.id), i = lc(i).sort();
				var j = h || {};
				if(d) {
					if("string" != typeof d) throw new TypeError("conversation name " + d + " is not a string");
					j.name = d
				}
				e && (console.warn("DEPRECATION createConversation options.attributes param: Use options[propertyName] instead. See https://url.leanapp.cn/DeprecateAttributes for more details."), j.attr = e), j = new yd({
					data: yb(j)
				});
				var k = {
					m: i,
				...
				return Pa.resolve(new Gd({
					cmd: "conv",
					op: "start",
					convMessage: new Cd(k)
				})).then(function(b) {
					if(a.options.conversationSignatureFactory) {
						var c = [null, a.id, i, "create"];
						return hg(a.options.conversationSignatureFactory, c).then(function(a) {
							return Ua(b.convMessage, Vc({
								signature: "s",
								timestamp: "t",
								nonce: "n"
							}, a)), b
					...
					return b
				}).then(this._send.bind(this)).then(function(b) {
					return new ug(Qf({
						name: d,
						attr: e,
						transient: f,
						unique: g,
						id: b.convMessage.cid,
						createdAt: b.convMessage.cdate,
						updatedAt: b.convMessage.cdate,
						lastMessageAt: null,
						creator: a.id,
						members: f ? [] : i
					}, h), a)
				}).then(Tc(function(b) {
					return a._conversationCache.set(b.id, b)
				}))
			}, b.prototype.markAllAsRead = function(a) {
				if(!Array.isArray(a)) throw new TypeError(a + " is not an Array");
				var b = a.map(function(a) {
					if(!(a instanceof ug)) throw new TypeError(a + " is not a Conversation");
					return a.id
				});
				return this._debug("mark [" + b + "] as read"), a.length ? this._send(new Gd({
					cmd: "read",
					readMessage: new Fd({
						convs: a.map(function(a) {
							return new Ed({
								cid: a.id,
								timestamp: (a.lastMessageAt || new Date).getTime()
							})
						})
					})
				}), !1).then(function() {
					return a.forEach(function(a) {
						return a.unreadMessagesCount = 0
					}), a
				}) : Pa.resolve([])
			}, b
		}(dg),
		tg = sb("LC:Conversation"),
		ug = function(a) {
			function b(c, d) {
				var e = c.id,
					f = c.creator,
					...
					s = c.muted,
					t = void 0 !== s && s,
					u = Td(c, ["id", "creator", "createdAt", "updatedAt", "lastMessageAt", "lastMessage", "mutedMembers", "members", "transient", "system", "muted"]);
				Wa(this, b);
				var v = ib(this, a.call(this));
				if(Ua(v, {
						id: e,
						creator: f,
						createdAt: g,
						...
						system: r,
						muted: t
					}), v._attributes = u, v._reset(), v.unreadMessagesCount = 0, v.members = lc(new tc(v.members)), _c(v).messagesWaitingForReciept = {}, !(d instanceof sg)) throw new TypeError("Conversation must be initialized with a client");
				return v._client = d, ["kicked", "membersjoined", "membersleft", "message"].forEach(function(a) {
					return v.on(a, function() {
						for(var b = arguments.length, c = Array(b), d = 0; d < b; d++) c[d] = arguments[d];
						return v._debug.apply(v, [a + " event emitted."].concat(c))
					})
				}), Nd(v._client._plugins.onConversationCreate, v), v
			}
			return pb(b, a), b.prototype.setAttributes = function(a) {
				var b = this,
					c = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
				if(console.warn("DEPRECATION Conversation#setAttributes: Use conversation.set() instead. See https://url.leanapp.cn/DeprecateAttributes for more details."), this._debug("set attributes: value=" + yb(a) + ", assign=" + c), !Ic(a)) throw new TypeError("attributes must be a plain object");
				return c ? yc(a).forEach(function(c) {
					return b.setAttribute(c, a[c])
				}) : this.set("attr", a), this
			}, b.prototype.setAttribute = function(a, b) {
				return console.warn("DEPRECATION Conversation#setAttribute: Use conversation.set('attr.key', value) instead. See https://url.leanapp.cn/DeprecateAttributes for more details."), this.set("attr." + a, b)
			}, b.prototype.setName = function(a) {
				return console.warn("DEPRECATION Conversation#setName: Use conversation.set('name', value) instead. See https://url.leanapp.cn/DeprecateAttributes for more details."), this.set("name", a)
			}, b.prototype.get = function(a) {
				return _c(this).currentAttributes[a]
			}, b.prototype.set = function(a, b) {
				this._debug("set [" + a + "]: " + b);
				var c = _c(this).pendingAttributes,
					d = yc(c),
					e = new RegExp("^" + a),
					f = d.filter(e.test.bind(e));
				if(f.forEach(function(a) {
						delete c[a]
					}), f.length) c[a] = b;
				else {
					var g = Rd(d, function(b) {
						return 0 === a.indexOf(b)
					});
					g ? dd(c[g], a.slice(g.length + 1), b) : c[a] = b
				}
				return _c(this).currentAttributes = yc(c).reduce(function(a, b) {
					return dd(a, b, c[b])
				}, Of(this._attributes)), this
			}, b.prototype._reset = function() {
				_c(this).pendingAttributes = {}, _c(this).currentAttributes = this._attributes
			}, b.prototype._debug = function() {
				for(var a = arguments.length, b = Array(a), c = 0; c < a; c++) b[c] = arguments[c];
				tg.apply(void 0, b.concat(["[" + this.id + "]"]))
			}, b.prototype._send = function(a) {
				var b;
				null === a.cmd && (a.cmd = "conv"), "conv" === a.cmd && null === a.convMessage && (a.convMessage = new Cd), a.convMessage && null === a.convMessage.cid && (a.convMessage.cid = this.id);
				for(var c = arguments.length, d = Array(c > 1 ? c - 1 : 0), e = 1; e < c; e++) d[e - 1] = arguments[e];
				return(b = this._client)._send.apply(b, [a].concat(d))
			}, b.prototype.save = function() {
				var a = this;
				this._debug("save");
				var b = _c(this).pendingAttributes;
				if(ue(b)) return this._debug("nothing touched, resolve with self"), Pa.resolve(this);
				this._debug("attr: " + yb(b));
				var c = new Cd({
					attr: new yd({
						data: yb(b)
					})
				});
				return this._send(new Gd({
					op: "update",
					convMessage: c
				})).then(function(b) {
					return a.updatedAt = b.convMessage.udate, a._attributes = _c(a).currentAttributes, _c(a).pendingAttributes = {}, a
				})
				...
				var a = this;
				return this._debug("mute"), this._send(new Gd({
					op: "mute"
				})).then(function() {
					return a.transient || (a.muted = !0, a.mutedMembers = Yc(a.mutedMembers, [a._client.id])), a
				})
			}, b.prototype.unmute = function() {
				var a = this;
				return this._debug("unmute"), this._send(new Gd({
					op: "unmute"
				})).then(function() {
					return a.transient || (a.muted = !1, a.mutedMembers = Zc(a.mutedMembers, [a._client.id])), a
				})
			}, b.prototype.count = function() {
				return this._debug("unmute"), this._send(new Gd({
					op: "count"
				})).then(function(a) {
					return a.convMessage.count
				})
			}, b.prototype.add = function(a) {
				var b = this;
				this._debug("add", a), "string" == typeof a && (a = [a]);
				var c = new Cd({
					m: a
				});
				return Pa.resolve(new Gd({
					...
					if(b._client.options.conversationSignatureFactory) {
						var d = [b.id, b._client.id, a.sort(), "add"];
						return hg(b._client.options.conversationSignatureFactory, d).then(function(a) {
							return Ua(c.convMessage, Vc({
								signature: "s",
								timestamp: "t",
								nonce: "n"
							}, a)), c
					...
					return b.transient || b.system || (b.members = Yc(b.members, a)), b
				})
			}, b.prototype.remove = function(a) {
				var b = this;
				this._debug("remove", a), "string" == typeof a && (a = [a]);
				var c = new Cd({
					m: a
				});
				return Pa.resolve(new Gd({
					...
					if(b._client.options.conversationSignatureFactory) {
						var d = [b.id, b._client.id, a.sort(), "remove"];
						return hg(b._client.options.conversationSignatureFactory, d).then(function(a) {
							return Ua(c.convMessage, Vc({
								signature: "s",
								timestamp: "t",
					...
					return b.transient || b.system || (b.members = Zc(b.members, a)), b
				})
			}, b.prototype.join = function() {
				return this._debug("join"), this.add(this._client.id)
			}, b.prototype.quit = function() {
				return this._debug("quit"), this.remove(this._client.id)
			}, b.prototype.send = function(a, b) {
				var c = this;
				if(this._debug(a, "send"), !(a instanceof pg)) throw new TypeError(a + " is not a Message");
				var d = Ua({
						transient: a.transient,
						reciept: a.needReceipt
					}, a.constructor.sendOptions, b),
					e = d.transient,
					f = d.reciept,
					g = d.priority,
					h = d.pushData;
				f && (this.transient ? console.warn("receipt option is ignored as the conversation is transient.") : e ? console.warn("receipt option is ignored as the message is sent transiently.") : this.members.length > 2 && console.warn("receipt option is recommended to be used in one-on-one conversation.")), g && !this.transient && console.warn("priority option is ignored as the conversation is not transient."), Ua(a, {
					cid: this.id,
					from: this._client.id
				}), a._setStatus(ig.SENDING);
				var i = a.toJSON();
				"string" != typeof i && (i = yb(i));
				var j = this._send(new Gd({
					cmd: "direct",
					directMessage: new Ad({
						msg: i,
						cid: this.id,
						r: f,
						transient: a.transient,
				...
				return e || (j = j.then(function(b) {
					...
					Ua(a, {
						id: e,
						timestamp: new Date(f.toNumber())
					}), c.lastMessage = a, c.lastMessageAt = a.timestamp
				})), j.then(function() {
					return a._setStatus(ig.SENT), f && (_c(c).messagesWaitingForReciept[a.id] = a), a
				}, function(b) {
					throw a._setStatus(ig.FAILED), b
				})
			}, b.prototype.queryMessages = function() {
				var a = this,
					b = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
				if(this._debug("query messages", b), b.beforeMessageId && !b.beforeTime) throw new Error("query option beforeMessageId must be used with option beforeTime");
				if(b.afterMessageId && !b.afterTime) throw new Error("query option afterMessageId must be used with option afterTime");
				var c = Vc({
					beforeTime: "t",
					beforeMessageId: "mid",
					afterTime: "tt",
				...
				return c.t instanceof Date && (c.t = c.t.getTime()), c.tt instanceof Date && (c.tt = c.tt.getTime()), this._send(new Gd({
					cmd: "logs",
					logsMessage: new Dd(Ua(c, {
						cid: this.id
					}))
				})).then(function(b) {
					return Pa.all(b.logsMessage.logs.map(function(b) {
						return a._client._messageParser.parse(b.data).then(function(c) {
							var d = {
								id: b.msgId,
								cid: a.id,
								timestamp: new Date(b.timestamp.toNumber()),
								from: b.from
							};
							return Ua(c, d), c._setStatus(ig.SENT), c
						})
					}))
				})
			}, b.prototype.createMessagesIterator = function() {
				var a = this,
					b = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
					c = b.beforeTime,
					d = b.beforeMessageId,
				...
				return {
					next: function() {
						return f = void 0 === f ? a.queryMessages({
							limit: e,
							beforeTime: c,
							beforeMessageId: d
						}) : f.then(function(b) {
							return 0 === b.length || b.length < e ? [] : a.queryMessages({
								beforeTime: b[0].timestamp,
								beforeMessageId: b[0].id,
								limit: e
							})
						}), f.then(function(a) {
							return {
								value: lc(a),
								done: 0 === a.length || a.length < e
							}
						})
					}
				}
			...
			}, b.prototype._handleReceipt = function(a) {
				var b = a.messageId,
					c = a.deliveredAt,
					d = _c(this),
					e = d.messagesWaitingForReciept,
					f = e[b];
				delete e[b], f && (f._setStatus(ig.DELIVERED), f.deliveredAt = c, this.emit("receipt", {
					message: f
				}))
			}, Lc(b, [{
				key: "createdAt",
				set: function(a) {
					this._createdAt = Uc(a)
				},
				get: function() {
				...
				key: "attributes",
				get: function() {
					return console.warn("DEPRECATION Conversation.attributes: Use conversation.get('attr') instead. See https://url.leanapp.cn/DeprecateAttributes for more details."), this.get("attr")
				},
				set: function(a) {
					console.warn("DEPRECATION Conversation.attributes: Use conversation.set('attr', value) instead. See https://url.leanapp.cn/DeprecateAttributes for more details."), this.set("attr", a)
				}
			}, {
				key: "name",
				get: function() {
		...
		xg = function(a, b, c) {
			...
			c.value = function(a) {
				var b = this;
				return Pa.resolve(a).then(Od(this._plugins.beforeMessageParse)).then(function(a) {
					return d.call(b, a)
				}).then(Od(this._plugins.afterMessageParse))
			}
		},
		yg = (jg = function() {
			function a() {
				var b = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
				Wa(this, a), this._plugins = b, this._messageClasses = []
			}
			return a.prototype.register = function(a) {
				if(!(a && a.parse && a.prototype && a.prototype.toJSON)) throw new TypeError("Invalid messageClass");
				this._messageClasses.unshift(a)
			}, a.prototype.parse = function(a) {
				vg("parsing message:", a);
				var b = !0,
					c = !1,
					d = void 0;
				try {
					for(var e, f = Xf(this._messageClasses); !(b = (e = f.next()).done); b = !0) {
						var g = e.value,
							h = Ic(a) ? Ua({}, a) : a,
							i = void 0,
							j = void 0;
						...
						if(i) {
							...
							if(void 0 !== j) return vg("parse result:", j), j
						}
					}
				} catch(a) {
					c = !0, d = a
		...
		}(), f(jg.prototype, "parse", [wg, xg], bc(jg.prototype, "parse"), jg.prototype), jg),
		zg = function(a) {
			if("number" != typeof a) throw new TypeError(a + " is not a Number");
			return function(b) {
				b.TYPE = a, b.validate = function(b) {
					return b._lctype === a
				}, b.prototype._getType = function() {
					return {
						_lctype: a
					}
				}
		...
		Ag = function(a) {
			...
			return function(b) {
				var c = Wc ? Xc(b, "_customFields") : b._customFields;
				c = Array.isArray(c) ? c : [], b._customFields = c.concat(a)
			}
		},
		Bg = function(a) {
			Wc && (a.parse = Xc(a, "parse"))
		},
		Cg = (kg = Ag(["_lctext", "_lcattrs"]), kg(lg = function(a) {
			function b() {
				Wa(this, b);
				var c = ib(this, a.call(this));
				return c._ = {}, c
			}
			return pb(b, a), b.prototype.setText = function(a) {
				return this._lctext = a, this
			}, b.prototype.getText = function() {
				return this._lctext
			}, b.prototype.setAttributes = function(a) {
				return this._lcattrs = a, this
			}, b.prototype.getAttributes = function() {
				return this._lcattrs
			}, b.prototype._getCustomFields = function() {
				var a = this,
					b = Array.isArray(this.constructor._customFields) ? this.constructor._customFields : [];
				return b.reduce(function(b, c) {
					return "string" != typeof c ? b : (b[c] = a[c], b)
				}, {})
			}, b.prototype._getType = function() {
				...
				var c = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : new this;
				c.content = b;
				var d = Wc ? Xc(c.constructor, "_customFields") : c.constructor._customFields,
					e = Array.isArray(d) ? d : [];
				return e = e.reduce(function(a, c) {
					return "string" != typeof c ? a : (a[c] = b[c], a)
				}, {}), Ua(c, e), a.parse.call(this, b, c)
			}, Lc(b, [{
				key: "type",
				get: function() {
		...
		Dg = (mg = zg(-1), mg(ng = Bg(ng = function(a) {
			function b() {
				var c = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
				if(Wa(this, b), "string" != typeof c) throw new TypeError(c + " is not a string");
				var d = ib(this, a.call(this));
				return d.setText(c), d
			}
			return pb(b, a), b
		}(Cg)) || ng) || ng),
		Eg = sb("LC:Realtime"),
		Fg = new Rc("push-router"),
		Gg = function(a) {
			function b(c) {
				Wa(this, b), Eg("initializing Realtime");
				var d = ib(this, a.call(this));
				if("string" != typeof c.appId) throw new TypeError("appId [" + c.appId + "] is not a string");
				return d._options = Ua({
					appId: void 0,
					region: "cn",
					pushOfflineMessages: !1,
					noBinary: ed,
					ssl: !0
				}, c), d._id = $b.v4(), d._cache = new Rc("endpoints"), d._clients = {}, d._plugins = cd(c.plugins).reduce(function(a, b) {
					for(var c in b)({}).hasOwnProperty.call(b, c) && "name" !== c && (b.name && cd(b[c]).forEach(function(a) {
						a._pluginName = b.name
					}), a[c] = cd(a[c]).concat(b[c]));
					return a
				}, {}), d._messageParser = new yg(d._plugins), d.register([pg, Dg]), Nd(d._plugins.onRealtimeCreate, d), d.register(cd(d._plugins.messageClasses)), d
			}
			return pb(b, a), b.prototype._open = function() {
				var a = this;
				if(this._openPromise) return this._openPromise;
				var b = "protobuf";
				this._options.noBinary && (b = "protobase64");
				var c = 3;
				this._options.pushOfflineMessages && (c = 1);
				var d = {
					format: b,
					version: c
				};
				return this._openPromise = new Pa(function(b, c) {
					Eg("No connection established, create a new one.");
					var e = new Ld(function() {
						return a._getEndpoints(a._options)
					}, d);
					e.binaryType = "arraybuffer", e.on("open", function() {
						return b(e)
					}), e.on("error", c), e.on("message", a._dispatchMessage.bind(a)), ["disconnect", "reconnect", "retry", "schedule"].forEach(function(b) {
						return e.on(b, function() {
							for(var c = arguments.length, d = Array(c), e = 0; e < c; e++) d[e] = arguments[e];
							Eg.apply(void 0, [b + " event emitted."].concat(d)), a.emit.apply(a, [b].concat(d)), "reconnect" !== b && ma(a._clients).forEach(function(a) {
								a.emit.apply(a, [b].concat(d))
							})
						})
					}), e.handleClose = function(a) {
						var b = ga([od.APP_NOT_AVAILABLE, od.INVALID_LOGIN, od.INVALID_ORIGIN], function(b) {
							return b === a.code
						});
						b ? this.throw(pd(a)) : this.disconnect()
					}, _c(a).connection = e
				}), this._openPromise
			}, b.prototype._getEndpoints = function(a) {
				var b = this;
				return Pa.resolve(this._cache.get("endpoints") || this.constructor._fetchEndpointsInfo(a).then(Tc(function(a) {
					return b._cache.set("endpoints", a, 1e3 * a.ttl)
				}))).then(function(a) {
					return Eg("endpoint info:", a), [a.server, a.secondary]
				})
			}, b._fetchPushRouter = function(a) {
				var b = a.appId,
					c = a.region;
				switch(Eg("fetch router"), c) {
					case "cn":
						var d = Fg.get(b);
						return d ? Pa.resolve(d) : Vb.get("https://app-router.leancloud.cn/1/route", {
							params: {
								appId: b
							},
							timeout: 2e4
							...
							return a.data
						}).then(Tc(Eg)).then(function(a) {
							var c = a.push_router_server;
							if(!c) throw new Error("push router not exists");
							var d = a.ttl;
							return "number" != typeof d && (d = 3600), Fg.set(b, c, 1e3 * d), c
						}).catch(function() {
							return "router-g0-push.leancloud.cn"
						});
					case "us":
						return Pa.resolve("router-a0-push.leancloud.cn");
					default:
						throw new Error("Region [" + c + "] is not supported.")
				}
			}, b._fetchEndpointsInfo = function(a) {
				var b = a.appId,
					c = a.region,
					d = a.ssl,
					e = a.server;
				return Eg("fetch endpoint info"), this._fetchPushRouter({
					appId: b,
					region: c
				}).then(Tc(Eg)).then(function(a) {
					return Vb.get("https://" + a + "/v1/route", {
						params: {
							appId: b,
							secure: d,
							features: ed ? "wechat" : void 0,
							server: e,
							_t: Date.now()
						},
						timeout: 2e4
				...
				this._openPromise && this._openPromise.then(function(a) {
					return a.close()
				}), delete this._openPromise
			}, b.prototype.retry = function() {
				var a = _c(this).connection;
				if(!a) throw new Error("no connection established");
				if(a.cannot("retry")) throw new Error("retrying not allowed when not offline. the connection is now " + a.current);
				return a.retry()
			}, b.prototype._register = function(a) {
				if(!(a instanceof dg)) throw new TypeError(a + " is not a Client");
				if(!a.id) throw new Error("Client must have an id to be registered");
				this._clients[a.id] = a
			}, b.prototype._deregister = function(a) {
				if(!(a instanceof dg)) throw new TypeError(a + " is not a Client");
				if(!a.id) throw new Error("Client must have an id to be deregistered");
				delete this._clients[a.id], 0 === Y(this._clients).length && this._close()
			}, b.prototype._dispatchMessage = function(a) {
				if(null !== a.peerId) {
					var b = this._clients[a.peerId];
					return b ? Pa.resolve(b).then(function(b) {
						return b._dispatchMessage(a)
					}).catch(Eg) : Eg("[WARN] Unexpected message received without any live client match", bd(a))
				}
				return Eg("[WARN] Unexpected message received without peerId", bd(a))
			}, b.prototype.createIMClient = function(a, b, c) {
				var d = this,
					e = "string" == typeof a;
				if(e && void 0 !== this._clients[a]) return Pa.resolve(this._clients[a]);
				var f = this._open().then(function(e) {
					var f = new sg(a, b, e, {
						_messageParser: d._messageParser,
						_plugins: d._plugins
					});
					return e.on("reconnect", function() {
						return f._open(d._options.appId, c, d._id, !0).then(function() {
							return f.emit("reconnect")
						}, function(a) {
							return f.emit("reconnecterror", a)
						})
					}), _c(f)._eventemitter.on("close", function() {
						return d._deregister(f)
					}, d), f._open(d._options.appId, c, d._id).then(function() {
						return d._register(f), f
					})
				});
				return e && (this._clients[a] = f), f
			}, b.prototype.register = function(a) {
				return cd(a).map(this._messageParser.register.bind(this._messageParser))
			}, b.defineConversationProperty = function(a) {
				var b = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {
					get: function() {
						return this.get(a)
					},
	...
	E(Hg), a.Realtime = Gg, a.Message = pg, a.TypedMessage = Cg, a.TextMessage = Dg, a.messageType = zg, a.messageField = Ag, a.IE10Compatible = Bg, a.MessagePriority = Hg, a.MessageStatus = ig, a.ErrorCode = od, Object.defineProperty(a, "__esModule", {
		value: !0
	})
});
